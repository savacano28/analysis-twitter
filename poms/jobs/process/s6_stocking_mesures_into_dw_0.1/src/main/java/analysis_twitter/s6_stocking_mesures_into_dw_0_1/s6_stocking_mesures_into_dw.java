...
package analysis_twitter.s6_stocking_mesures_into_dw_0_1;
...
/**
 * Job: s6_stocking_mesures_into_dw Purpose: s6_stocking_mesures_into_dw<br>
 * Description: s6_stocking_mesures_into_dw <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s6_stocking_mesures_into_dw implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s6_stocking_mesures_into_dw";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s6_stocking_mesures_into_dw.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s6_stocking_mesures_into_dw.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s6_stocking_mesures_into_dw) {
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_ht.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_3 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_3 >0 || random_value_tFileInputDelimited_3 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_regions.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_id.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_4 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_4 >0 || random_value_tFileInputDelimited_4 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_4 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_fr.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_5 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_5 >0 || random_value_tFileInputDelimited_5 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_5 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_fr.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_6 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_6 >0 || random_value_tFileInputDelimited_6 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_6 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_fr.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_7 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_7 >0 || random_value_tFileInputDelimited_7 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_7 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_in.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_8 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_8 >0 || random_value_tFileInputDelimited_8 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_in.csv", "US-ASCII",";","\n",false,1,0,
	...
	final routines.system.RowState rowstate_tFileInputDelimited_9 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_9 >0 || random_value_tFileInputDelimited_9 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_9 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_in.csv", "US-ASCII",";","\n",false,1,0,
 ...
 */
	...
	String titletMsgBox_1 = "Step6: Stocking mesures";
	String messagetMsgBox_1 = "Stocking mesures";   	
 ...
 */
    ...
    public static void main(String[] args){
        final s6_stocking_mesures_into_dw s6_stocking_mesures_into_dwClass = new s6_stocking_mesures_into_dw();

        int exitCode = s6_stocking_mesures_into_dwClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s6_stocking_mesures_into_dw.class.getClassLoader().getResourceAsStream("analysis_twitter/s6_stocking_mesures_into_dw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s6_stocking_mesures_into_dw.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s6_stocking_mesures_into_dw");
        }
...
/************************************************************************************************
 *     289722 characters generated by Talend Open Studio for Big Data 
 *     on the December 6, 2020 4:06:08 PM CET
 ************************************************************************************************/