...
/**
 * Job: s5_fr_calculate_sentiments_from_tweets Purpose: s5_fr_calculate_sentiments_from_tweets<br>
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s5_fr_calculate_sentiments_from_tweets.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s5_fr_calculate_sentiments_from_tweets.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s5_fr_calculate_sentiments_from_tweets.length == 0) {
			...
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s5_fr_calculate_sentiments_from_tweets, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	String titletMsgBox_1 = "Étape5: Calcul de sentiments";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s5_fr_calculate_sentiments_from_tweets.class.getClassLoader().getResourceAsStream("analysis_twitter/s5_fr_calculate_sentiments_from_tweets_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s5_fr_calculate_sentiments_from_tweets.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s5_fr_calculate_sentiments_from_tweets");
        }
...
/************************************************************************************************
 *     244024 characters generated by Talend Open Studio for Big Data 
