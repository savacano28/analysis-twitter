...
package analysis_twitter.s0_connexion_api_twitter_0_1;
...
/**
 * Job: s0_connexion_api_twitter Purpose: s0_connexion_api_twitter<br>
 * Description: s0_connexion_api_twitter <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s0_connexion_api_twitter implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "s0_connexion_api_twitter";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s0_connexion_api_twitter.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s0_connexion_api_twitter.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class coronaWarnAPPStruct implements routines.system.IPersistableRow<coronaWarnAPPStruct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s0_connexion_api_twitter = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s0_connexion_api_twitter) {
...
try {
	...
	final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:S+vt8YQpVmrqF3CyHVH1CqI3Jxp8B03q6Exkdenpz3IVhHnu");
	...
	final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:NxKrxaS13flaEFELQ4habK2jtEiH9JdXmP3PDrAlFZ688bVA");
	...
	final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6shOwUF6/u6D5OEtDjzGGM3KK3P5XFZTfYadhGfqAQLlDyWA");
	...
	final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:gX5VaL/5nOz5lpLR8E3nOLgXmztpJLtTvQg2bA888Q0ZDwlJ");
...
try {
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:eStzmihtJ6T4dt6dwBINNJd7vri83oRLbNF2xbHrJhnbEOjr");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7+HmO6qLcZ+Jf1NaftJMWkRcCpsX4TkLQIMicZSQMSoWVyXt");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DcBSGKc/wujWZc5pWlQZwIHxXwUG6I3x/KKJmU7uFEPjQKvQ");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SIOKMojEKWuttNlQp/+CXKdTZIIOE3KC9X2vAgKA9tC+d+ub");
...
try {
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:v4f1WTcdNPiaC4hEVvGxCDxjeDZ/dCKG62n9AmdBIqFuNMDx");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:lZgDizw8GukM282Db6RlsSKY7Mf3JIyb82+O8P10IAZBS9aH");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3Xqjt1LYivJBReajrOpKco0gZDqY1fRLQBR5BbhTkFoWxi1Y");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Xt7GGE1V9SC0H6QphHnefvCYFlNm8mm6JL69PilhYaF0NQ5/");
 ...
 */
    ...
    public static void main(String[] args){
        final s0_connexion_api_twitter s0_connexion_api_twitterClass = new s0_connexion_api_twitter();

        int exitCode = s0_connexion_api_twitterClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s0_connexion_api_twitter.class.getClassLoader().getResourceAsStream("analysis_twitter/s0_connexion_api_twitter_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s0_connexion_api_twitter.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s0_connexion_api_twitter");
        }
...
/************************************************************************************************
 *     163100 characters generated by Talend Open Studio for Big Data 
 *     on the December 6, 2020 8:56:43 PM CET
 ************************************************************************************************/