	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s0_connection_api_twitter_0_1.s0_connection_api_twitter childJob_tRunJob_1 = new analysis_twitter.s0_connection_api_twitter_0_1.s0_connection_api_twitter();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s1_stocking_data_into_db_0_1.s1_stocking_data_into_db childJob_tRunJob_2 = new analysis_twitter.s1_stocking_data_into_db_0_1.s1_stocking_data_into_db();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s2_stocking_data_into_dw_0_1.s2_stocking_data_into_dw childJob_tRunJob_3 = new analysis_twitter.s2_stocking_data_into_dw_0_1.s2_stocking_data_into_dw();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s3_stocking_hierarchies_data_into_dw_0_1.s3_stocking_hierarchies_data_into_dw childJob_tRunJob_4 = new analysis_twitter.s3_stocking_hierarchies_data_into_dw_0_1.s3_stocking_hierarchies_data_into_dw();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s4_calculate_mesures_0_1.s4_calculate_mesures childJob_tRunJob_5 = new analysis_twitter.s4_calculate_mesures_0_1.s4_calculate_mesures();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s5_fr_calculate_sentiments_from_tweets_0_1.s5_fr_calculate_sentiments_from_tweets childJob_tRunJob_6 = new analysis_twitter.s5_fr_calculate_sentiments_from_tweets_0_1.s5_fr_calculate_sentiments_from_tweets();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s5_in_calculate_sentiments_from_tweets_0_1.s5_in_calculate_sentiments_from_tweets childJob_tRunJob_7 = new analysis_twitter.s5_in_calculate_sentiments_from_tweets_0_1.s5_in_calculate_sentiments_from_tweets();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s6_stocking_mesures_into_dw_0_1.s6_stocking_mesures_into_dw childJob_tRunJob_8 = new analysis_twitter.s6_stocking_mesures_into_dw_0_1.s6_stocking_mesures_into_dw();
				// pass DataSources
...
/************************************************************************************************
 * 84010 characters generated by Talend Open Studio for Big Data on the December
 * 6, 2020 8:17:37 PM CET
 ************************************************************************************************/