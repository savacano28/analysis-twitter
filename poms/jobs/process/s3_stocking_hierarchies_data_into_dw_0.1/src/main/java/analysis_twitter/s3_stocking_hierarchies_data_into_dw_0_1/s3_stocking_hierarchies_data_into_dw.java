...
/**
 * Job: s3_stocking_hierarchies_data_into_dw Purpose:
 * s3_stocking_hierarchies_data_into_dw<br>
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(s3_stocking_hierarchies_data_into_dw.this,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw.length) {
					if (length < 1024
							&& commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw.length == 0) {
				...
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"hashtag\" VARCHAR(50)  ,\"text\" VARCHAR ,primary key(\"text\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"text\" = ?");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_2.next()) {
						...
						if (table_tDBOutput_2.equals(("dim_region")) && (schema_tDBOutput_2.equals(dbschema_tDBOutput_2)
				...
				if (!whetherExist_tDBOutput_2) {
					try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
						stmtCreate_tDBOutput_2.execute("CREATE TABLE \"" + tableName_tDBOutput_2
								+ "\"(\"country\" VARCHAR(50)  ,\"localisation\" VARCHAR ,primary key(\"localisation\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_2 + "\" WHERE \"localisation\" = ?");
				resourceMap.put("pstmt_tDBOutput_2", pstmt_tDBOutput_2);
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2
						+ "\" (\"country\",\"localisation\") VALUES (?,?)";
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"country\" = ? WHERE \"localisation\" = ?";
...
// Start of branch "dim_hashtag"
						if (dim_hashtag != null) {
							...
							if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
								...
								row2.hashtag = dim_hashtag.hashtag;
								row2.text = dim_hashtag.text;
...
// Start of branch "row2"
							if (row2 != null) {
								...
								if (row2.text == null) {
									...
									pstmt_tDBOutput_1.setString(1, row2.text);
								}
								...
								if (checkCount_tDBOutput_1 > 0) {
									if (row2.hashtag == null) {
										...
										pstmtUpdate_tDBOutput_1.setString(1, row2.hashtag);
									}

									if (row2.text == null) {
										pstmtUpdate_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(2 + count_tDBOutput_1, row2.text);
									}
									...
									if (row2.hashtag == null) {
										...
										pstmtInsert_tDBOutput_1.setString(1, row2.hashtag);
									}

									if (row2.text == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(2, row2.text);
									}
...
// Start of branch "dim_country"
						if (dim_country != null) {
							...
							row3.country = dim_country.country;
							row3.localisation = dim_country.localisation;
...
// Start of branch "row3"
							if (row3 != null) {
								...
								if (row3.localisation == null) {
									...
									pstmt_tDBOutput_2.setString(1, row3.localisation);
								}
								...
								if (checkCount_tDBOutput_2 > 0) {
									if (row3.country == null) {
										...
										pstmtUpdate_tDBOutput_2.setString(1, row3.country);
									}

									if (row3.localisation == null) {
										pstmtUpdate_tDBOutput_2.setNull(2 + count_tDBOutput_2, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_2.setString(2 + count_tDBOutput_2, row3.localisation);
									}
									...
									if (row3.country == null) {
										...
										pstmtInsert_tDBOutput_2.setString(1, row3.country);
									}

									if (row3.localisation == null) {
										pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_2.setString(2, row3.localisation);
									}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s3_stocking_hierarchies_data_into_dw.class.getClassLoader()
					.getResourceAsStream("analysis_twitter/s3_stocking_hierarchies_data_into_dw_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = s3_stocking_hierarchies_data_into_dw.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s3_stocking_hierarchies_data_into_dw");
		}
...
/************************************************************************************************
 * 99874 characters generated by Talend Open Studio for Big Data on the December
 * 6, 2020 7:43:15 AM CET
 ************************************************************************************************/