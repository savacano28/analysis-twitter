...
package analysis_twitter.s3_stocking_hierarchies_data_into_dw_0_1;
...
/**
 * Job: s3_stocking_hierarchies_data_into_dw Purpose: s3_stocking_hierarchies_data_into_dw<br>
 * Description: s3_stocking_hierarchies_data_into_dw <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s3_stocking_hierarchies_data_into_dw implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s3_stocking_hierarchies_data_into_dw";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s3_stocking_hierarchies_data_into_dw.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s3_stocking_hierarchies_data_into_dw.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s3_stocking_hierarchies_data_into_dw) {
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.text, other.text);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("dim_hashtag_text");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("dim_hashtag_text");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("dim_hashtag_text"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"hashtag\" VARCHAR(50)  ,\"text\" VARCHAR ,primary key(\"text\"))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"text\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"hashtag\",\"text\") VALUES (?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"hashtag\" = ? WHERE \"text\" = ?";
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("dim_region");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("dim_region");
}
...
int count_tDBOutput_2=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_2.next()) {
                                        ...
                                        if(table_tDBOutput_2.equals(("dim_region"))
                                ...
                                if(!whetherExist_tDBOutput_2) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
                                        stmtCreate_tDBOutput_2.execute("CREATE TABLE \"" + tableName_tDBOutput_2 + "\"(\"country\" VARCHAR(50)  ,\"localisation\" VARCHAR ,primary key(\"localisation\"))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_2 + "\" WHERE \"localisation\" = ?");
	    resourceMap.put("pstmt_tDBOutput_2", pstmt_tDBOutput_2);
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"country\",\"localisation\") VALUES (?,?)";
	    ...
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"country\" = ? WHERE \"localisation\" = ?";
...
StringHandling.LEN(row1.hashtag_description)>1 & row1.hashtag_description != ""

 ) {
dim_hashtag_tmp.hashtag = row1.hashtag ;
dim_hashtag_tmp.text = row1.hashtag_description ;
...
StringHandling.LEN(row1.geo)>1 & row1.geo != ""

 ) {
dim_country_tmp.country = row1.country ;
dim_country_tmp.localisation = row1.geo ;
...
row2 = null;			
if(dim_hashtag.text == null){
	finder_tUniqRow_2.text = null;
}else{
	finder_tUniqRow_2.text = dim_hashtag.text.toLowerCase();
}	
...
if(dim_hashtag.text == null){
	new_tUniqRow_2.text = null;
}else{
	new_tUniqRow_2.text = dim_hashtag.text.toLowerCase();
}
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.hashtag = dim_hashtag.hashtag;			row2.text = dim_hashtag.text;					
...
} else {pstmt_tDBOutput_1.setString(1, row2.text);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(1, row2.hashtag);
}

                        if(row2.text == null) {
pstmtUpdate_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2 + count_tDBOutput_1, row2.text);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row2.hashtag);
}

                        if(row2.text == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, row2.text);
}
...
row3.country = dim_country.country;			row3.localisation = dim_country.localisation;			
...
if(row3 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(row3.localisation == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, row3.localisation);
}
...
} else {pstmtUpdate_tDBOutput_2.setString(1, row3.country);
}

                        if(row3.localisation == null) {
pstmtUpdate_tDBOutput_2.setNull(2 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2 + count_tDBOutput_2, row3.localisation);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, row3.country);
}

                        if(row3.localisation == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, row3.localisation);
}
 ...
 */
	...
	String titletMsgBox_1 = "Step3: Stocking into hierarchy dimension tbs";
	String messagetMsgBox_1 = "Stocking data into hierarchy dimensions tb";   	
 ...
 */
    ...
    public static void main(String[] args){
        final s3_stocking_hierarchies_data_into_dw s3_stocking_hierarchies_data_into_dwClass = new s3_stocking_hierarchies_data_into_dw();

        int exitCode = s3_stocking_hierarchies_data_into_dwClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s3_stocking_hierarchies_data_into_dw.class.getClassLoader().getResourceAsStream("analysis_twitter/s3_stocking_hierarchies_data_into_dw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s3_stocking_hierarchies_data_into_dw.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s3_stocking_hierarchies_data_into_dw");
        }
...
/************************************************************************************************
 *     99874 characters generated by Talend Open Studio for Big Data 
