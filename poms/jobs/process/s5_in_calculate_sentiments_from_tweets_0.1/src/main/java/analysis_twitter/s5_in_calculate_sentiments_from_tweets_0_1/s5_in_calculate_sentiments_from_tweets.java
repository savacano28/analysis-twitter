...
package analysis_twitter.s5_in_calculate_sentiments_from_tweets_0_1;
...
/**
 * Job: s5_in_calculate_sentiments_from_tweets Purpose: s5_in_calculate_sentiments_from_tweets<br>
 * Description: s5_in_calculate_sentiments_from_tweets <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s5_in_calculate_sentiments_from_tweets implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s5_in_calculate_sentiments_from_tweets";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s5_in_calculate_sentiments_from_tweets.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s5_in_calculate_sentiments_from_tweets.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s5_in_calculate_sentiments_from_tweets) {
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_in.csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_in.csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_in.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public static void main(String[] args){
        final s5_in_calculate_sentiments_from_tweets s5_in_calculate_sentiments_from_tweetsClass = new s5_in_calculate_sentiments_from_tweets();

        int exitCode = s5_in_calculate_sentiments_from_tweetsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s5_in_calculate_sentiments_from_tweets.class.getClassLoader().getResourceAsStream("analysis_twitter/s5_in_calculate_sentiments_from_tweets_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s5_in_calculate_sentiments_from_tweets.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s5_in_calculate_sentiments_from_tweets");
        }
...
/************************************************************************************************
 *     237292 characters generated by Talend Open Studio for Big Data 
