	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s2_stocking_data_into_dw, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
				...
				class KeyStruct_tUniqRow_4 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.date_description == null) ? 0 : this.date_description.hashCode());
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s2_stocking_data_into_dw.class.getClassLoader().getResourceAsStream(
					"analysis_twitter/s2_stocking_data_into_dw_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = s2_stocking_data_into_dw.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s2_stocking_data_into_dw");
		}
...
/************************************************************************************************
 * 165745 characters generated by Talend Open Studio for Big Data on the
 * December 6, 2020 7:22:38 AM CET
 ************************************************************************************************/