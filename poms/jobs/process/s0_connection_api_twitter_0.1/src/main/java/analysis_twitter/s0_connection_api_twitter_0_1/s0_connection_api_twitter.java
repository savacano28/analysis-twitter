				...
				try {
					...
					if (use_auth_tRESTClient_1 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:Jp5C4EWs48E/iWdbWUhzCQFdWI99Mh4K4CBrEBStQr8VpxKY");
					...
					if (use_auth_tRESTClient_1 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:VfLwsb9uNPw3Yz7fhHtgOJjWLcOABvKIf4Rra+sF9gVNupZ3");
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:GBNNogekvUAU1ALIoMZ5W5nacOQUa+JVdWu4O9TXVTMPnigt");
					...
					if (use_auth_tRESTClient_1 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:VqNPHL6ki2m7ATa456tVqfmGyRaLTBq87bXQRZFxavwquQCi");
				...
				try {
					...
					if (use_auth_tRESTClient_2 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:LUoqa28kx95g8fyGYAxiBSkADdDZgVQuNCRQVtamZ6lKvNS4");
					...
					if (use_auth_tRESTClient_2 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:XBEmNz5MEd9jsRBMnbBrBzpacbJwBAHKGMjsP7bmhXwpdF7R");
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:y121m5ulOmv5lRmWZOHDqWuSTLypSUoSCiyk74mdN2irgOfn");
					...
					if (use_auth_tRESTClient_2 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:w8BkRxVMmX+zo8KaWi6NslNemKO5L55bGiRHgOUD5mXbqzPA");
...
// [tRESTCliend_end]
				...
				java.io.File file_tFileOutputJSON_2 = new java.io.File(
						"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/apitwitter/fr-dic-06.json");
				...
				try {
					...
					if (use_auth_tRESTClient_3 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:OazacJoTarWaND5MAakmf+pVddw4/SrDctdsukAOcX+3pMR2");
					...
					if (use_auth_tRESTClient_3 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:4wn5PZFeLtG+Voe2JCu+15T5G2kHbi3uy0XKFTBBflr2yZCY");
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:ZmF3NjC1BvymnIpaTLLXjoLxKL0VyCK+Ah+EAs5Xf1yU6cb8");
					...
					if (use_auth_tRESTClient_3 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:AYNdQQ+eiRRe7VqtjHAGdPpu82tGrB0Ws7jkOWvT7Qn3txj2");
...
// [tRESTCliend_end]
				...
				java.io.File file_tFileOutputJSON_3 = new java.io.File(
						"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/apitwitter/in-dic-06.json");
...
/************************************************************************************************
 * 163070 characters generated by Talend Open Studio for Big Data on the
 * December 6, 2020 3:04:49 PM CET
 ************************************************************************************************/