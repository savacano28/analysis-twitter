...
package analysis_twitter.s0_connection_api_twitter_0_1;
...
/**
 * Job: s0_connection_api_twitter Purpose: s0_connection_api_twitter<br>
 * Description: s0_connection_api_twitter <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s0_connection_api_twitter implements TalendJob {
	...
	private final String jobName = "s0_connection_api_twitter";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					s0_connection_api_twitter.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(s0_connection_api_twitter.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class coronaWarnAPPStruct implements routines.system.IPersistableRow<coronaWarnAPPStruct> {
		final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[0];
		static byte[] commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter.length) {
					if (length < 1024 && commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter.length == 0) {
						commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[1024];
					} else {
						commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter, 0, length);
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ANALYSIS_TWITTER_s0_connection_api_twitter) {
...
// [tRESTCliend_end]
				...
				java.io.File file_tFileOutputJSON_1 = new java.io.File(
						"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/apitwitter/al-dic-05.json");
...
// Start of branch "coronaWarnAPP"
	...
	public static class copyOfcoronaWarnAPPStruct
			implements routines.system.IPersistableRow<copyOfcoronaWarnAPPStruct> {
		final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[0];
		static byte[] commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(copyOfcoronaWarnAPPStruct other) {
	...
	public void tRESTClient_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				copyOfcoronaWarnAPPStruct copyOfcoronaWarnAPP = new copyOfcoronaWarnAPPStruct();
...
// ###############################
// # Outputs initialization
				copyOfcoronaWarnAPPStruct copyOfcoronaWarnAPP_tmp = new copyOfcoronaWarnAPPStruct();
				copyOfcoronaWarnAPPStruct copyOfcoronaWarnAPP_save = null;
//the aggregate variable
				copyOfcoronaWarnAPPStruct copyOfcoronaWarnAPP_aggregate = null;
//init the resultset for aggregate
				...
				if (row2 != null) {
					...
					for (java.util.Map<String, String> oneRow_tXMLMap_2_TXMLMAP_OUT : resultSet_tXMLMap_2_TXMLMAP_OUT) { // G_TXM_M_001
						...
						{ // start of Var scope
							...
							copyOfcoronaWarnAPP = null;

// # Output table : 'copyOfcoronaWarnAPP'

							copyOfcoronaWarnAPP_tmp = new copyOfcoronaWarnAPPStruct();
							copyOfcoronaWarnAPP_tmp.id = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/id");
							copyOfcoronaWarnAPP_tmp.date_description = TalendDate
									.parseDate("EEE MMM dd HH:mm:ss Z yyyy", treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
											.get_String("row2.body:/root/statuses/created_at"));
							copyOfcoronaWarnAPP_tmp.user_id = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/user/id");
							copyOfcoronaWarnAPP_tmp.user_name = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/user/name");
							copyOfcoronaWarnAPP_tmp.user_screen_name = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/user/screen_name");
							copyOfcoronaWarnAPP_tmp.user_location = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
							...
							copyOfcoronaWarnAPP_tmp.hashtag_id = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/id");
							copyOfcoronaWarnAPP_tmp.geo_id = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/id");
							copyOfcoronaWarnAPP_tmp.geo_description = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/user/location");
							copyOfcoronaWarnAPP_tmp.text_id = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/id");
							copyOfcoronaWarnAPP_tmp.date_id = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
									.get_String("row2.body:/root/statuses/id");
							allOutsForAggregate_tXMLMap_2.add(copyOfcoronaWarnAPP_tmp);
...
// [tRESTCliend_end]
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "copyOfcoronaWarnAPP");
				}
				...
				java.io.File file_tFileOutputJSON_2 = new java.io.File(
						"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/apitwitter/fr-dic-05.json");
				...
				for (Object row_out_tXMLMap_2_TXMLMAP_IN : outs_tXMLMap_2) {// TD512
					...
					if (row_out_tXMLMap_2_TXMLMAP_IN != null
							&& row_out_tXMLMap_2_TXMLMAP_IN instanceof copyOfcoronaWarnAPPStruct) {
						copyOfcoronaWarnAPP = (copyOfcoronaWarnAPPStruct) row_out_tXMLMap_2_TXMLMAP_IN;
					}
					 ...
					 */
// Start of branch "copyOfcoronaWarnAPP"
					if (copyOfcoronaWarnAPP != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "copyOfcoronaWarnAPP");
						}

						org.json.simple.JSONObject jsonRowtFileOutputJSON_2 = new org.json.simple.JSONObject();
						if (copyOfcoronaWarnAPP.id != null) {

							jsonRowtFileOutputJSON_2.put("id", copyOfcoronaWarnAPP.id);

						} else {
							jsonRowtFileOutputJSON_2.put("id", null);
						}

						if (copyOfcoronaWarnAPP.date_description != null) {

							jsonRowtFileOutputJSON_2.put("date_description",
									FormatterUtils.format_Date(copyOfcoronaWarnAPP.date_description, "dd-MM-yyyy"));

						} else {
							jsonRowtFileOutputJSON_2.put("date_description", null);
						}

						if (copyOfcoronaWarnAPP.user_id != null) {

							jsonRowtFileOutputJSON_2.put("user_id", copyOfcoronaWarnAPP.user_id);

						} else {
							jsonRowtFileOutputJSON_2.put("user_id", null);
						}

						if (copyOfcoronaWarnAPP.user_name != null) {

							jsonRowtFileOutputJSON_2.put("user_name", copyOfcoronaWarnAPP.user_name);

						} else {
							jsonRowtFileOutputJSON_2.put("user_name", null);
						}

						if (copyOfcoronaWarnAPP.user_screen_name != null) {

							jsonRowtFileOutputJSON_2.put("user_screen_name", copyOfcoronaWarnAPP.user_screen_name);

						} else {
							jsonRowtFileOutputJSON_2.put("user_screen_name", null);
						}

						if (copyOfcoronaWarnAPP.user_location != null) {

							jsonRowtFileOutputJSON_2.put("user_location", copyOfcoronaWarnAPP.user_location);

						} else {
							jsonRowtFileOutputJSON_2.put("user_location", null);
						}

						if (copyOfcoronaWarnAPP.user_description != null) {

							jsonRowtFileOutputJSON_2.put("user_description", copyOfcoronaWarnAPP.user_description);

						} else {
							jsonRowtFileOutputJSON_2.put("user_description", null);
						}

						if (copyOfcoronaWarnAPP.hashtag_text != null) {

							jsonRowtFileOutputJSON_2.put("hashtag_text", copyOfcoronaWarnAPP.hashtag_text);

						} else {
							jsonRowtFileOutputJSON_2.put("hashtag_text", null);
						}

						if (copyOfcoronaWarnAPP.text_description != null) {

							jsonRowtFileOutputJSON_2.put("text_description", copyOfcoronaWarnAPP.text_description);

						} else {
							jsonRowtFileOutputJSON_2.put("text_description", null);
						}

						if (copyOfcoronaWarnAPP.hashtag_id != null) {

							jsonRowtFileOutputJSON_2.put("hashtag_id", copyOfcoronaWarnAPP.hashtag_id);

						} else {
							jsonRowtFileOutputJSON_2.put("hashtag_id", null);
						}

						if (copyOfcoronaWarnAPP.geo_id != null) {

							jsonRowtFileOutputJSON_2.put("geo_id", copyOfcoronaWarnAPP.geo_id);

						} else {
							jsonRowtFileOutputJSON_2.put("geo_id", null);
						}

						if (copyOfcoronaWarnAPP.geo_description != null) {

							jsonRowtFileOutputJSON_2.put("geo_description", copyOfcoronaWarnAPP.geo_description);

						} else {
							jsonRowtFileOutputJSON_2.put("geo_description", null);
						}

						if (copyOfcoronaWarnAPP.text_id != null) {

							jsonRowtFileOutputJSON_2.put("text_id", copyOfcoronaWarnAPP.text_id);

						} else {
							jsonRowtFileOutputJSON_2.put("text_id", null);
						}

						if (copyOfcoronaWarnAPP.date_id != null) {

							jsonRowtFileOutputJSON_2.put("date_id", copyOfcoronaWarnAPP.date_id);
					...
					} // End of branch "copyOfcoronaWarnAPP"
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "copyOfcoronaWarnAPP");
				}
	...
	public static class copyOfcopyOfcoronaWarnAPPStruct
			implements routines.system.IPersistableRow<copyOfcopyOfcoronaWarnAPPStruct> {
		final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[0];
		static byte[] commonByteArray_ANALYSIS_TWITTER_s0_connection_api_twitter = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(copyOfcopyOfcoronaWarnAPPStruct other) {
	...
	public void tRESTClient_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				copyOfcopyOfcoronaWarnAPPStruct copyOfcopyOfcoronaWarnAPP = new copyOfcopyOfcoronaWarnAPPStruct();
...
// ###############################
// # Outputs initialization
				copyOfcopyOfcoronaWarnAPPStruct copyOfcopyOfcoronaWarnAPP_tmp = new copyOfcopyOfcoronaWarnAPPStruct();
				copyOfcopyOfcoronaWarnAPPStruct copyOfcopyOfcoronaWarnAPP_save = null;
//the aggregate variable
				copyOfcopyOfcoronaWarnAPPStruct copyOfcopyOfcoronaWarnAPP_aggregate = null;
//init the resultset for aggregate
				...
				if (row3 != null) {
					...
					for (java.util.Map<String, String> oneRow_tXMLMap_3_TXMLMAP_OUT : resultSet_tXMLMap_3_TXMLMAP_OUT) { // G_TXM_M_001
						...
						{ // start of Var scope
							...
							copyOfcopyOfcoronaWarnAPP = null;

// # Output table : 'copyOfcopyOfcoronaWarnAPP'

							copyOfcopyOfcoronaWarnAPP_tmp = new copyOfcopyOfcoronaWarnAPPStruct();
							copyOfcopyOfcoronaWarnAPP_tmp.id = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/id");
							copyOfcopyOfcoronaWarnAPP_tmp.date_description = TalendDate
									.parseDate("EEE MMM dd HH:mm:ss Z yyyy", treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
											.get_String("row3.body:/root/statuses/created_at"));
							copyOfcopyOfcoronaWarnAPP_tmp.user_id = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/user/id");
							copyOfcopyOfcoronaWarnAPP_tmp.user_name = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/user/name");
							copyOfcopyOfcoronaWarnAPP_tmp.user_screen_name = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/user/screen_name");
							copyOfcopyOfcoronaWarnAPP_tmp.user_location = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
							...
							copyOfcopyOfcoronaWarnAPP_tmp.hashtag_id = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/id");
							copyOfcopyOfcoronaWarnAPP_tmp.geo_id = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/id");
							copyOfcopyOfcoronaWarnAPP_tmp.geo_description = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/user/location");
							copyOfcopyOfcoronaWarnAPP_tmp.text_id = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/id");
							copyOfcopyOfcoronaWarnAPP_tmp.date_id = treeNodeAPI_tXMLMap_3_TXMLMAP_OUT
									.get_String("row3.body:/root/statuses/id");
							allOutsForAggregate_tXMLMap_3.add(copyOfcopyOfcoronaWarnAPP_tmp);
...
// [tRESTCliend_end]
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "copyOfcopyOfcoronaWarnAPP");
				}
				...
				java.io.File file_tFileOutputJSON_3 = new java.io.File(
						"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/apitwitter/in-dic-05.json");
				...
				for (Object row_out_tXMLMap_3_TXMLMAP_IN : outs_tXMLMap_3) {// TD512
					...
					if (row_out_tXMLMap_3_TXMLMAP_IN != null
							&& row_out_tXMLMap_3_TXMLMAP_IN instanceof copyOfcopyOfcoronaWarnAPPStruct) {
						copyOfcopyOfcoronaWarnAPP = (copyOfcopyOfcoronaWarnAPPStruct) row_out_tXMLMap_3_TXMLMAP_IN;
					}
					 ...
					 */
// Start of branch "copyOfcopyOfcoronaWarnAPP"
					if (copyOfcopyOfcoronaWarnAPP != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "copyOfcopyOfcoronaWarnAPP");
						}

						org.json.simple.JSONObject jsonRowtFileOutputJSON_3 = new org.json.simple.JSONObject();
						if (copyOfcopyOfcoronaWarnAPP.id != null) {

							jsonRowtFileOutputJSON_3.put("id", copyOfcopyOfcoronaWarnAPP.id);

						} else {
							jsonRowtFileOutputJSON_3.put("id", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.date_description != null) {

							jsonRowtFileOutputJSON_3.put("date_description", FormatterUtils
									.format_Date(copyOfcopyOfcoronaWarnAPP.date_description, "dd-MM-yyyy"));

						} else {
							jsonRowtFileOutputJSON_3.put("date_description", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.user_id != null) {

							jsonRowtFileOutputJSON_3.put("user_id", copyOfcopyOfcoronaWarnAPP.user_id);

						} else {
							jsonRowtFileOutputJSON_3.put("user_id", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.user_name != null) {

							jsonRowtFileOutputJSON_3.put("user_name", copyOfcopyOfcoronaWarnAPP.user_name);

						} else {
							jsonRowtFileOutputJSON_3.put("user_name", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.user_screen_name != null) {

							jsonRowtFileOutputJSON_3.put("user_screen_name",
									copyOfcopyOfcoronaWarnAPP.user_screen_name);

						} else {
							jsonRowtFileOutputJSON_3.put("user_screen_name", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.user_location != null) {

							jsonRowtFileOutputJSON_3.put("user_location", copyOfcopyOfcoronaWarnAPP.user_location);

						} else {
							jsonRowtFileOutputJSON_3.put("user_location", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.user_description != null) {

							jsonRowtFileOutputJSON_3.put("user_description",
									copyOfcopyOfcoronaWarnAPP.user_description);

						} else {
							jsonRowtFileOutputJSON_3.put("user_description", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.hashtag_text != null) {

							jsonRowtFileOutputJSON_3.put("hashtag_text", copyOfcopyOfcoronaWarnAPP.hashtag_text);

						} else {
							jsonRowtFileOutputJSON_3.put("hashtag_text", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.text_description != null) {

							jsonRowtFileOutputJSON_3.put("text_description",
									copyOfcopyOfcoronaWarnAPP.text_description);

						} else {
							jsonRowtFileOutputJSON_3.put("text_description", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.hashtag_id != null) {

							jsonRowtFileOutputJSON_3.put("hashtag_id", copyOfcopyOfcoronaWarnAPP.hashtag_id);

						} else {
							jsonRowtFileOutputJSON_3.put("hashtag_id", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.geo_id != null) {

							jsonRowtFileOutputJSON_3.put("geo_id", copyOfcopyOfcoronaWarnAPP.geo_id);

						} else {
							jsonRowtFileOutputJSON_3.put("geo_id", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.geo_description != null) {

							jsonRowtFileOutputJSON_3.put("geo_description", copyOfcopyOfcoronaWarnAPP.geo_description);

						} else {
							jsonRowtFileOutputJSON_3.put("geo_description", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.text_id != null) {

							jsonRowtFileOutputJSON_3.put("text_id", copyOfcopyOfcoronaWarnAPP.text_id);

						} else {
							jsonRowtFileOutputJSON_3.put("text_id", null);
						}

						if (copyOfcopyOfcoronaWarnAPP.date_id != null) {

							jsonRowtFileOutputJSON_3.put("date_id", copyOfcopyOfcoronaWarnAPP.date_id);
					...
					} // End of branch "copyOfcopyOfcoronaWarnAPP"
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "copyOfcopyOfcoronaWarnAPP");
				}
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String titletMsgBox_1 = "Étape 0: Appel à l'API twitter et stockage de réponses";
				String messagetMsgBox_1 = "Le réponse a été sauvargé";
	...
	public static void main(String[] args) {
		final s0_connection_api_twitter s0_connection_api_twitterClass = new s0_connection_api_twitter();

		int exitCode = s0_connection_api_twitterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s0_connection_api_twitter.class.getClassLoader().getResourceAsStream(
					"analysis_twitter/s0_connection_api_twitter_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = s0_connection_api_twitter.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s0_connection_api_twitter");
		}
