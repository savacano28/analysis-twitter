...
public class s4_calculate_mesures implements TalendJob {
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (row1.hashtag != null) {
							sb_tFileOutputDelimited_1.append(row1.hashtag);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.no_ht != null) {
							sb_tFileOutputDelimited_1.append(row1.no_ht);
						}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBInput_2 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (row2.date != null) {
							sb_tFileOutputDelimited_2.append(row2.date);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row2.hashtag != null) {
							sb_tFileOutputDelimited_2.append(row2.hashtag);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row2.country != null) {
							sb_tFileOutputDelimited_2.append(row2.country);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row2.no_users != null) {
							sb_tFileOutputDelimited_2.append(row2.no_users);
						}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBInput_3 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (row3.date != null) {
							sb_tFileOutputDelimited_3.append(row3.date);
						}
						sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row3.hashtag != null) {
							sb_tFileOutputDelimited_3.append(row3.hashtag);
						}
						sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row3.country != null) {
							sb_tFileOutputDelimited_3.append(row3.country);
						}
						sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row3.no_regions != null) {
							sb_tFileOutputDelimited_3.append(row3.no_regions);
						}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s4_calculate_mesures.class.getClassLoader().getResourceAsStream(
					"analysis_twitter/s4_calculate_mesures_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = s4_calculate_mesures.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : s4_calculate_mesures");
		}
...
/************************************************************************************************
 * 90491 characters generated by Talend Open Studio for Big Data on the December
 * 6, 2020 9:01:14 AM CET
 ************************************************************************************************/