...
package analysis_twitter.s4_calculate_mesures_0_1;
...
/**
 * Job: s4_calculate_mesures Purpose: s4_calculate_mesures<br>
 * Description: s4_calculate_mesures <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s4_calculate_mesures implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s4_calculate_mesures";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s4_calculate_mesures.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s4_calculate_mesures.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s4_calculate_mesures = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s4_calculate_mesures) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_ht.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("country");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("no_ht");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.connection_postgres_Password; 
		    ...
		    String dbquery_tDBInput_1 = "select to_char(d.date,'dd-MM-yyyy') as date,d.hashtag as hashtag,d.country as country, count(distinct d.id) as no_ht fr"
+"om all_tweets d group by d.date, d.hashtag,d.country order by d.date asc;";
        	...
        	row1.hashtag = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
            ...
            row1.no_ht = rs_tDBInput_1.getLong(4);
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    static byte[] commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures = new byte[0];
			    ...
			    public Long no_users;

				public Long getNo_users () {
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.no_users == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.no_users);
		            	}
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_id.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        ...
                                        outtFileOutputDelimited_2.write("country");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("no_users");
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_2 = null;
				...
				String dbUser_tDBInput_2 = context.connection_postgres_Login;
				
				
	final String decryptedPassword_tDBInput_2 = context.connection_postgres_Password; 
				
				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;
				
				String url_tDBInput_2 = "jdbc:postgresql://" + context.connection_postgres_Server + ":" + context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?" + context.connection_postgres_AdditionalParams;
		    ...
		    String dbquery_tDBInput_2 = "select to_char(d.date,'dd-MM-yyyy') as date,d.hashtag as hashtag,d.country as country,count(distinct d.user_id) as no_u"
+"sers from all_tweets d group by d.date, d.hashtag,d.country order by d.date asc;";
        	...
        	row2.hashtag = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
            ...
            row2.no_users = rs_tDBInput_2.getLong(4);
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    ...
    static byte[] commonByteArray_ANALYSIS_TWITTER_s4_calculate_mesures = new byte[0];
			    ...
			    public Long no_regions;

				public Long getNo_regions () {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.country = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.no_regions = null;
           				} else {
           			    	this.no_regions = dis.readLong();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Long
						...
						if(this.no_regions == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.no_regions);
		            	}
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_regions.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_3, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_3.length()==0){
                                        ...
                                        outtFileOutputDelimited_3.write("country");
                                            outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
                                        outtFileOutputDelimited_3.write("no_regions");
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_3 = null;
				...
				String dbUser_tDBInput_3 = context.connection_postgres_Login;
				
				
	final String decryptedPassword_tDBInput_3 = context.connection_postgres_Password; 
				
				String dbPwd_tDBInput_3 = decryptedPassword_tDBInput_3;
				
				String url_tDBInput_3 = "jdbc:postgresql://" + context.connection_postgres_Server + ":" + context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?" + context.connection_postgres_AdditionalParams;
		    ...
		    String dbquery_tDBInput_3 = "select to_char(d.date,'dd-MM-yyyy') as date,d.hashtag as hashtag,d.country as country,count(distinct d.geo) as no_regio"
+"ns from all_tweets d group by d.date, d.hashtag,d.country order by d.date asc;";
        	...
        	row3.date = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row3.hashtag = null;
							} else {
	                         		
        	row3.hashtag = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
        	...
        	row3.country = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
							...
							if(colQtyInRs_tDBInput_3 < 4) {
								row3.no_regions = null;
							} else {
		                          
            row3.no_regions = rs_tDBInput_3.getLong(4);
 ...
 */
	...
	String titletMsgBox_1 = "Step4: Calculate mesures";
	String messagetMsgBox_1 = "Calculate mesures";   	
 ...
 */
    ...
    public static void main(String[] args){
        final s4_calculate_mesures s4_calculate_mesuresClass = new s4_calculate_mesures();

        int exitCode = s4_calculate_mesuresClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s4_calculate_mesures.class.getClassLoader().getResourceAsStream("analysis_twitter/s4_calculate_mesures_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s4_calculate_mesures.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s4_calculate_mesures");
        }
...
/************************************************************************************************
 *     89453 characters generated by Talend Open Studio for Big Data 
