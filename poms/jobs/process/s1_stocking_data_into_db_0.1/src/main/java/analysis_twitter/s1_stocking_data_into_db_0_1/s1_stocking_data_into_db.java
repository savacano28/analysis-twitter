...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s1_stocking_data_into_db, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	String titletMsgBox_1 = "Step1: Stocking tweets into db";
	String messagetMsgBox_1 = "Stocking tweets into db";   	
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s1_stocking_data_into_db.class.getClassLoader().getResourceAsStream("analysis_twitter/s1_stocking_data_into_db_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s1_stocking_data_into_db.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s1_stocking_data_into_db");
        }
...
/************************************************************************************************
 *     258741 characters generated by Talend Open Studio for Big Data 
