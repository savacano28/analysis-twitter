	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s1_telechargement_tweets_dedans_db_0_1.s1_telechargement_tweets_dedans_db childJob_tRunJob_10 = new analysis_twitter.s1_telechargement_tweets_dedans_db_0_1.s1_telechargement_tweets_dedans_db();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s2_telechargement_donnees_dedans_dw_0_1.s2_telechargement_donnees_dedans_dw childJob_tRunJob_11 = new analysis_twitter.s2_telechargement_donnees_dedans_dw_0_1.s2_telechargement_donnees_dedans_dw();
				// pass DataSources
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s3_telechargement_donnees_region_info_hashtag_0_1.s3_telechargement_donnees_region_info_hashtag childJob_tRunJob_12 = new analysis_twitter.s3_telechargement_donnees_region_info_hashtag_0_1.s3_telechargement_donnees_region_info_hashtag();
				// pass DataSources
	...
	public void tRunJob_13Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s4_calcul_mesures_0_1.s4_calcul_mesures childJob_tRunJob_13 = new analysis_twitter.s4_calcul_mesures_0_1.s4_calcul_mesures();
				// pass DataSources
	...
	public void tRunJob_15Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s5_in_calcul_sentiments_depuis_donnees_tweets_0_1.s5_in_calcul_sentiments_depuis_donnees_tweets childJob_tRunJob_15 = new analysis_twitter.s5_in_calcul_sentiments_depuis_donnees_tweets_0_1.s5_in_calcul_sentiments_depuis_donnees_tweets();
				// pass DataSources
	...
	public void tRunJob_16Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				analysis_twitter.s6_telechargement_mesures_dedans_dw_0_1.s6_telechargement_mesures_dedans_dw childJob_tRunJob_16 = new analysis_twitter.s6_telechargement_mesures_dedans_dw_0_1.s6_telechargement_mesures_dedans_dw();
				// pass DataSources
