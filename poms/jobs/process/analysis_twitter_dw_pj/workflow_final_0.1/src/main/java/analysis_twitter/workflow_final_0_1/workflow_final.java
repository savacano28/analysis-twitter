...
public class workflow_final implements TalendJob {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_2 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_2.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_2.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_2.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_2.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_2.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_2
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
				...
				if (obj_tRunJob_2 != null) {
					paraList_tRunJob_2.add(
							"--context_param path_files_global=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
				} else {
					paraList_tRunJob_2.add("--context_param path_files_global="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
				...
				if (obj_tRunJob_2 != null) {
					paraList_tRunJob_2.add("--context_param connection_postgres_Port="
				...
				if (obj_tRunJob_2 != null) {
					paraList_tRunJob_2.add("--context_param connection_postgres_Password="
							+ RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
				} else {
					paraList_tRunJob_2.add("--context_param connection_postgres_Password="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				...
				if (obj_tRunJob_2 != null) {
					paraList_tRunJob_2.add("--context_param connection_postgres_Login="
							+ RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
				} else {
					paraList_tRunJob_2.add("--context_param connection_postgres_Login="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				...
				if (obj_tRunJob_2 != null) {
					paraList_tRunJob_2.add("--context_param connection_postgres_Server="
							+ RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
				} else {
					paraList_tRunJob_2.add("--context_param connection_postgres_Server="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				...
				if (obj_tRunJob_2 != null) {
					paraList_tRunJob_2.add("--context_param connection_postgres_Database="
							+ RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
				} else {
					paraList_tRunJob_2.add("--context_param connection_postgres_Database="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_1 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_1.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_1.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_1.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_1.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_1.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_1
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_3 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_3.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_3.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_3.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_3.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_3.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_3
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_4 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_4.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_4.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_4.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_4.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_4.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_4
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_5 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_5.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_5.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_5.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_5.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_5.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_5.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_5.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_5.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_5
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_6 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_6.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_6.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_6.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_6.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_6.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_6.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_6.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_6.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_6
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_7 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_7.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_7.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_7.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_7.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_7.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_7.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_7.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_7.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_7
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_8 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_8.put("connection_postgres_Server",
								context.connection_postgres_Server);
						...
						parentContextMap_tRunJob_8.put("connection_postgres_Password",
								context.connection_postgres_Password);
						paraList_tRunJob_8.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
						parentContextMap_tRunJob_8.put("connection_postgres_Database",
								context.connection_postgres_Database);
						paraList_tRunJob_8.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
						parentContextMap_tRunJob_8.put("connection_postgres_Schema",
								context.connection_postgres_Schema);
						paraList_tRunJob_8.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_8.put("connection_postgres_AdditionalParams",
								context.connection_postgres_AdditionalParams);
						paraList_tRunJob_8
								.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = workflow_final.class.getClassLoader()
					.getResourceAsStream("analysis_twitter/workflow_final_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = workflow_final.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : workflow_final");
		}
...
/************************************************************************************************
 * 115005 characters generated by Talend Open Studio for Big Data on the
 * December 9, 2020 10:52:18 PM CET
 ************************************************************************************************/