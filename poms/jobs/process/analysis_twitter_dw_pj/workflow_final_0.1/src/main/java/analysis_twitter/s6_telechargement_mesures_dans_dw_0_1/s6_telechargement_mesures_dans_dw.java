...
package analysis_twitter.s6_telechargement_mesures_dans_dw_0_1;
...
/**
 * Job: s6_telechargement_mesures_dans_dw Purpose: s6_telechargement_mesures_dans_dw<br>
 * Description: s6_telechargement_mesures_dans_dw <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s6_telechargement_mesures_dans_dw implements TalendJob {
...
public String getPath_files_global(){
	...
	private final String jobName = "s6_telechargement_mesures_dans_dw";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s6_telechargement_mesures_dans_dw.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s6_telechargement_mesures_dans_dw.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s6_telechargement_mesures_dans_dw) {
 ...
 */
    ...
    public static void main(String[] args){
        final s6_telechargement_mesures_dans_dw s6_telechargement_mesures_dans_dwClass = new s6_telechargement_mesures_dans_dw();

        int exitCode = s6_telechargement_mesures_dans_dwClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s6_telechargement_mesures_dans_dw.class.getClassLoader().getResourceAsStream("analysis_twitter/s6_telechargement_mesures_dans_dw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s6_telechargement_mesures_dans_dw.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s6_telechargement_mesures_dans_dw");
        }
...
/************************************************************************************************
 *     460303 characters generated by Talend Open Studio for Big Data 
 *     on the December 12, 2020 5:06:25 PM CET
 ************************************************************************************************/