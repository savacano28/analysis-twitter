...
/**
 * Job: s6_telechargement_mesures_dedans_dw Purpose:
 * s6_telechargement_mesures_dedans_dw<br>
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(s6_telechargement_mesures_dedans_dw.this,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dedans_dw.length) {
					if (length < 1024
							&& commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dedans_dw.length == 0) {
				...
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s6_telechargement_mesures_dedans_dw, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("fait_tweet")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(10)  ,\"no_ht\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1
								+ "\" WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"date\",\"hashtag\",\"country\",\"no_ht\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"no_ht\" = ? WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?";
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_ht.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_ht.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"no_ht", "row1", temp, ex_tFileInputDelimited_1),
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.hashtag == null) {
								...
								pstmt_tDBOutput_1.setString(2, row1.hashtag);
							}

							if (row1.country == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, row1.country);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row1.no_ht == null) {
									...
									pstmtUpdate_tDBOutput_1.setInt(1, row1.no_ht);
								}

								if (row1.date != null) {
									pstmtUpdate_tDBOutput_1.setTimestamp(2 + count_tDBOutput_1,
								...
								if (row1.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row1.hashtag);
								}

								if (row1.country == null) {
									pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(4 + count_tDBOutput_1, row1.country);
								}
								...
								if (row1.hashtag == null) {
									...
									pstmtInsert_tDBOutput_1.setString(2, row1.hashtag);
								}

								if (row1.country == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, row1.country);
								}

								if (row1.no_ht == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(4, row1.no_ht);
								}
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_ht.csv") instanceof java.io.InputStream)) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_2.next()) {
						...
						if (table_tDBOutput_2.equals(("fait_tweet")) && (schema_tDBOutput_2.equals(dbschema_tDBOutput_2)
				...
				if (!whetherExist_tDBOutput_2) {
					try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
						stmtCreate_tDBOutput_2.execute("CREATE TABLE \"" + tableName_tDBOutput_2
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(10)  ,\"no_regions\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				...
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2
						+ "\" (\"date\",\"hashtag\",\"country\",\"no_regions\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"no_regions\" = ? WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?";
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_regions.csv";
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_regions.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"no_regions", "row2", temp, ex_tFileInputDelimited_3),
...
// Start of branch "row2"
						if (row2 != null) {
							...
							if (row2.hashtag == null) {
								...
								pstmt_tDBOutput_2.setString(2, row2.hashtag);
							}
							...
							if (checkCount_tDBOutput_2 > 0) {
								if (row2.no_regions == null) {
									...
									pstmtUpdate_tDBOutput_2.setInt(1, row2.no_regions);
								}

								if (row2.date != null) {
									pstmtUpdate_tDBOutput_2.setTimestamp(2 + count_tDBOutput_2,
								...
								if (row2.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_2.setString(3 + count_tDBOutput_2, row2.hashtag);
								}

								if (row2.country == null) {
									pstmtUpdate_tDBOutput_2.setNull(4 + count_tDBOutput_2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_2.setString(4 + count_tDBOutput_2, row2.country);
								}
								...
								if (row2.hashtag == null) {
									...
									pstmtInsert_tDBOutput_2.setString(2, row2.hashtag);
								}

								if (row2.country == null) {
									pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(3, row2.country);
								}

								if (row2.no_regions == null) {
									pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_2.setInt(4, row2.no_regions);
								}
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_regions.csv") instanceof java.io.InputStream)) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_3 = dbMetaData_tDBOutput_3.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_3.next()) {
						...
						if (table_tDBOutput_3.equals(("fait_tweet")) && (schema_tDBOutput_3.equals(dbschema_tDBOutput_3)
				...
				if (!whetherExist_tDBOutput_3) {
					try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
						stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(10)  ,\"no_users\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				...
				String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3
						+ "\" (\"date\",\"hashtag\",\"country\",\"no_users\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3
						+ "\" SET \"no_users\" = ? WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?";
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_id.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_id.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"no_users", "row3", temp, ex_tFileInputDelimited_2),
...
// Start of branch "row3"
						if (row3 != null) {
							...
							if (row3.hashtag == null) {
								...
								pstmt_tDBOutput_3.setString(2, row3.hashtag);
							}
							...
							if (checkCount_tDBOutput_3 > 0) {
								if (row3.no_users == null) {
									...
									pstmtUpdate_tDBOutput_3.setInt(1, row3.no_users);
								}

								if (row3.date != null) {
									pstmtUpdate_tDBOutput_3.setTimestamp(2 + count_tDBOutput_3,
											new java.sql.Timestamp(row3.date.getTime()));
								} else {
								...
								if (row3.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_3.setString(3 + count_tDBOutput_3, row3.hashtag);
								}

								if (row3.country == null) {
									pstmtUpdate_tDBOutput_3.setNull(4 + count_tDBOutput_3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_3.setString(4 + count_tDBOutput_3, row3.country);
								}
								...
								if (row3.date != null) {
									pstmtInsert_tDBOutput_3.setTimestamp(1,
											new java.sql.Timestamp(row3.date.getTime()));
								} else {
								...
								if (row3.hashtag == null) {
									...
									pstmtInsert_tDBOutput_3.setString(2, row3.hashtag);
								}

								if (row3.country == null) {
									pstmtInsert_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_3.setString(3, row3.country);
								}

								if (row3.no_users == null) {
									pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_3.setInt(4, row3.no_users);
								}
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/nro_id.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputDelimited_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_4 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try (java.sql.ResultSet rsTable_tDBOutput_4 = dbMetaData_tDBOutput_4.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_4.next()) {
						...
						if (table_tDBOutput_4.equals(("fait_tweet")) && (schema_tDBOutput_4.equals(dbschema_tDBOutput_4)
				...
				if (!whetherExist_tDBOutput_4) {
					try (java.sql.Statement stmtCreate_tDBOutput_4 = conn_tDBOutput_4.createStatement()) {
						stmtCreate_tDBOutput_4.execute("CREATE TABLE \"" + tableName_tDBOutput_4
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(6)  ,\"s_negativos\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				...
				String insert_tDBOutput_4 = "INSERT INTO \"" + tableName_tDBOutput_4
						+ "\" (\"date\",\"hashtag\",\"country\",\"s_negativos\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4
						+ "\" SET \"s_negativos\" = ? WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?";
				...
				try {
					...
					Object filename_tFileInputDelimited_4 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_fr.csv";
					...
					try {
						fid_tFileInputDelimited_4 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_fr.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"s_negativos", "row4", temp, ex_tFileInputDelimited_4),
...
// Start of branch "row4"
						if (row4 != null) {
							...
							if (row4.hashtag == null) {
								...
								pstmt_tDBOutput_4.setString(2, row4.hashtag);
							}

							if (row4.country == null) {
								pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_4.setString(3, row4.country);
							}
							...
							if (checkCount_tDBOutput_4 > 0) {
								if (row4.s_negativos == null) {
									...
									pstmtUpdate_tDBOutput_4.setInt(1, row4.s_negativos);
								}

								if (row4.date != null) {
									pstmtUpdate_tDBOutput_4.setTimestamp(2 + count_tDBOutput_4,
								...
								if (row4.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_4.setString(3 + count_tDBOutput_4, row4.hashtag);
								}

								if (row4.country == null) {
									pstmtUpdate_tDBOutput_4.setNull(4 + count_tDBOutput_4, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_4.setString(4 + count_tDBOutput_4, row4.country);
								}
								...
								if (row4.hashtag == null) {
									...
									pstmtInsert_tDBOutput_4.setString(2, row4.hashtag);
								}

								if (row4.country == null) {
									pstmtInsert_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_4.setString(3, row4.country);
								}

								if (row4.s_negativos == null) {
									pstmtInsert_tDBOutput_4.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_4.setInt(4, row4.s_negativos);
								}
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_fr.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputDelimited_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_5 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try (java.sql.ResultSet rsTable_tDBOutput_5 = dbMetaData_tDBOutput_5.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_5.next()) {
						...
						if (table_tDBOutput_5.equals(("fait_tweet")) && (schema_tDBOutput_5.equals(dbschema_tDBOutput_5)
				...
				if (!whetherExist_tDBOutput_5) {
					try (java.sql.Statement stmtCreate_tDBOutput_5 = conn_tDBOutput_5.createStatement()) {
						stmtCreate_tDBOutput_5.execute("CREATE TABLE \"" + tableName_tDBOutput_5
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(6)  ,\"s_positivos\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				...
				String insert_tDBOutput_5 = "INSERT INTO \"" + tableName_tDBOutput_5
						+ "\" (\"date\",\"hashtag\",\"country\",\"s_positivos\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5
						+ "\" SET \"s_positivos\" = ? WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?";
				...
				try {
					...
					Object filename_tFileInputDelimited_5 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_fr.csv";
					...
					try {
						fid_tFileInputDelimited_5 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_fr.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"s_positivos", "row5", temp, ex_tFileInputDelimited_5),
...
// Start of branch "row5"
						if (row5 != null) {
							...
							if (row5.hashtag == null) {
								...
								pstmt_tDBOutput_5.setString(2, row5.hashtag);
							}

							if (row5.country == null) {
								pstmt_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_5.setString(3, row5.country);
							}
							...
							if (checkCount_tDBOutput_5 > 0) {
								if (row5.s_positivos == null) {
									...
									pstmtUpdate_tDBOutput_5.setInt(1, row5.s_positivos);
								}

								if (row5.date != null) {
									pstmtUpdate_tDBOutput_5.setTimestamp(2 + count_tDBOutput_5,
								...
								if (row5.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_5.setString(3 + count_tDBOutput_5, row5.hashtag);
								}

								if (row5.country == null) {
									pstmtUpdate_tDBOutput_5.setNull(4 + count_tDBOutput_5, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_5.setString(4 + count_tDBOutput_5, row5.country);
								}
								...
								if (row5.date != null) {
									pstmtInsert_tDBOutput_5.setTimestamp(1,
											new java.sql.Timestamp(row5.date.getTime()));
								} else {
								...
								if (row5.hashtag == null) {
									...
									pstmtInsert_tDBOutput_5.setString(2, row5.hashtag);
								}

								if (row5.country == null) {
									pstmtInsert_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_5.setString(3, row5.country);
								}

								if (row5.s_positivos == null) {
									pstmtInsert_tDBOutput_5.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_5.setInt(4, row5.s_positivos);
								}
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_fr.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputDelimited_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_6 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try (java.sql.ResultSet rsTable_tDBOutput_6 = dbMetaData_tDBOutput_6.getTables(null, null, null,
					...
					if (dbschema_tDBOutput_6 == null || dbschema_tDBOutput_6.trim().length() == 0) {
						try (java.sql.Statement stmtSchema_tDBOutput_6 = conn_tDBOutput_6.createStatement();
								java.sql.ResultSet rsSchema_tDBOutput_6 = stmtSchema_tDBOutput_6
										.executeQuery("select current_schema() ")) {
					...
					while (rsTable_tDBOutput_6.next()) {
						...
						if (table_tDBOutput_6.equals(("fait_tweet")) && (schema_tDBOutput_6.equals(dbschema_tDBOutput_6)
								|| ((dbschema_tDBOutput_6 == null || dbschema_tDBOutput_6.trim().length() == 0)
										&& defaultSchema_tDBOutput_6.equals(schema_tDBOutput_6)))) {
				...
				if (!whetherExist_tDBOutput_6) {
					try (java.sql.Statement stmtCreate_tDBOutput_6 = conn_tDBOutput_6.createStatement()) {
						stmtCreate_tDBOutput_6.execute("CREATE TABLE \"" + tableName_tDBOutput_6
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(6)  ,\"t_reception\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				...
				String insert_tDBOutput_6 = "INSERT INTO \"" + tableName_tDBOutput_6
						+ "\" (\"date\",\"hashtag\",\"country\",\"t_reception\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_6 = "UPDATE \"" + tableName_tDBOutput_6
						+ "\" SET \"t_reception\" = ? WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?";
				...
				try {
					...
					Object filename_tFileInputDelimited_6 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_fr.csv";
					...
					try {
						fid_tFileInputDelimited_6 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_fr.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_6.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"t_reception", "row6", temp, ex_tFileInputDelimited_6),
...
// Start of branch "row6"
						if (row6 != null) {
							...
							if (row6.hashtag == null) {
								...
								pstmt_tDBOutput_6.setString(2, row6.hashtag);
							}

							if (row6.country == null) {
								pstmt_tDBOutput_6.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_6.setString(3, row6.country);
							}
							...
							if (checkCount_tDBOutput_6 > 0) {
								if (row6.t_reception == null) {
									...
									pstmtUpdate_tDBOutput_6.setInt(1, row6.t_reception);
								}

								if (row6.date != null) {
									pstmtUpdate_tDBOutput_6.setTimestamp(2 + count_tDBOutput_6,
								...
								if (row6.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_6.setString(3 + count_tDBOutput_6, row6.hashtag);
								}

								if (row6.country == null) {
									pstmtUpdate_tDBOutput_6.setNull(4 + count_tDBOutput_6, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_6.setString(4 + count_tDBOutput_6, row6.country);
								}

								try {

									updatedCount_tDBOutput_6 = updatedCount_tDBOutput_6
											+ pstmtUpdate_tDBOutput_6.executeUpdate();
									nb_line_tDBOutput_6++;
								...
								if (row6.date != null) {
									pstmtInsert_tDBOutput_6.setTimestamp(1,
											new java.sql.Timestamp(row6.date.getTime()));
								} else {
								...
								if (row6.hashtag == null) {
									...
									pstmtInsert_tDBOutput_6.setString(2, row6.hashtag);
								}

								if (row6.country == null) {
									pstmtInsert_tDBOutput_6.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_6.setString(3, row6.country);
								}

								if (row6.t_reception == null) {
									pstmtInsert_tDBOutput_6.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_6.setInt(4, row6.t_reception);
								}

								try {

									insertedCount_tDBOutput_6 = insertedCount_tDBOutput_6
											+ pstmtInsert_tDBOutput_6.executeUpdate();
									nb_line_tDBOutput_6++;
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_fr.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputDelimited_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_7 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try (java.sql.ResultSet rsTable_tDBOutput_7 = dbMetaData_tDBOutput_7.getTables(null, null, null,
					...
					if (dbschema_tDBOutput_7 == null || dbschema_tDBOutput_7.trim().length() == 0) {
						try (java.sql.Statement stmtSchema_tDBOutput_7 = conn_tDBOutput_7.createStatement();
								java.sql.ResultSet rsSchema_tDBOutput_7 = stmtSchema_tDBOutput_7
										.executeQuery("select current_schema() ")) {
					...
					while (rsTable_tDBOutput_7.next()) {
						...
						if (table_tDBOutput_7.equals(("fait_tweet")) && (schema_tDBOutput_7.equals(dbschema_tDBOutput_7)
								|| ((dbschema_tDBOutput_7 == null || dbschema_tDBOutput_7.trim().length() == 0)
										&& defaultSchema_tDBOutput_7.equals(schema_tDBOutput_7)))) {
				...
				if (!whetherExist_tDBOutput_7) {
					try (java.sql.Statement stmtCreate_tDBOutput_7 = conn_tDBOutput_7.createStatement()) {
						stmtCreate_tDBOutput_7.execute("CREATE TABLE \"" + tableName_tDBOutput_7
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(10)  ,\"s_negativos\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_7 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_in.csv";
					...
					try {
						fid_tFileInputDelimited_7 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_in.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_7.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"s_negativos", "row7", temp, ex_tFileInputDelimited_7),
...
// Start of branch "row7"
						if (row7 != null) {
							...
							if (row7.hashtag == null) {
								...
								pstmt_tDBOutput_7.setString(2, row7.hashtag);
							}
							...
							if (checkCount_tDBOutput_7 > 0) {
								if (row7.s_negativos == null) {
									...
									pstmtUpdate_tDBOutput_7.setInt(1, row7.s_negativos);
								}

								if (row7.date != null) {
									pstmtUpdate_tDBOutput_7.setTimestamp(2 + count_tDBOutput_7,
											new java.sql.Timestamp(row7.date.getTime()));
								} else {
								...
								if (row7.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_7.setString(3 + count_tDBOutput_7, row7.hashtag);
								}

								if (row7.country == null) {
									pstmtUpdate_tDBOutput_7.setNull(4 + count_tDBOutput_7, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_7.setString(4 + count_tDBOutput_7, row7.country);
								}
								...
								if (row7.date != null) {
									pstmtInsert_tDBOutput_7.setTimestamp(1,
											new java.sql.Timestamp(row7.date.getTime()));
								} else {
								...
								if (row7.hashtag == null) {
									...
									pstmtInsert_tDBOutput_7.setString(2, row7.hashtag);
								}

								if (row7.country == null) {
									pstmtInsert_tDBOutput_7.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_7.setString(3, row7.country);
								}

								if (row7.s_negativos == null) {
									pstmtInsert_tDBOutput_7.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_7.setInt(4, row7.s_negativos);
								}
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_in.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputDelimited_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_8 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try (java.sql.ResultSet rsTable_tDBOutput_8 = dbMetaData_tDBOutput_8.getTables(null, null, null,
					...
					if (dbschema_tDBOutput_8 == null || dbschema_tDBOutput_8.trim().length() == 0) {
						try (java.sql.Statement stmtSchema_tDBOutput_8 = conn_tDBOutput_8.createStatement();
								java.sql.ResultSet rsSchema_tDBOutput_8 = stmtSchema_tDBOutput_8
										.executeQuery("select current_schema() ")) {
					...
					while (rsTable_tDBOutput_8.next()) {
						...
						if (table_tDBOutput_8.equals(("fait_tweet")) && (schema_tDBOutput_8.equals(dbschema_tDBOutput_8)
								|| ((dbschema_tDBOutput_8 == null || dbschema_tDBOutput_8.trim().length() == 0)
										&& defaultSchema_tDBOutput_8.equals(schema_tDBOutput_8)))) {
				...
				if (!whetherExist_tDBOutput_8) {
					try (java.sql.Statement stmtCreate_tDBOutput_8 = conn_tDBOutput_8.createStatement()) {
						stmtCreate_tDBOutput_8.execute("CREATE TABLE \"" + tableName_tDBOutput_8
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(10)  ,\"s_positivos\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_8 = conn_tDBOutput_8
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_8
								+ "\" WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?");
				...
				String update_tDBOutput_8 = "UPDATE \"" + tableName_tDBOutput_8
						+ "\" SET \"s_positivos\" = ? WHERE \"date\" = ? AND \"hashtag\" = ? AND \"country\" = ?";
				java.sql.PreparedStatement pstmtUpdate_tDBOutput_8 = conn_tDBOutput_8
						.prepareStatement(update_tDBOutput_8);
				...
				try {
					...
					Object filename_tFileInputDelimited_8 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_in.csv";
					...
					try {
						fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_in.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_8.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"s_positivos", "row8", temp, ex_tFileInputDelimited_8),
...
// Start of branch "row8"
						if (row8 != null) {
							...
							if (row8.hashtag == null) {
								...
								pstmt_tDBOutput_8.setString(2, row8.hashtag);
							}

							if (row8.country == null) {
								pstmt_tDBOutput_8.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_8.setString(3, row8.country);
							}
							...
							if (checkCount_tDBOutput_8 > 0) {
								if (row8.s_positivos == null) {
									...
									pstmtUpdate_tDBOutput_8.setInt(1, row8.s_positivos);
								}

								if (row8.date != null) {
									pstmtUpdate_tDBOutput_8.setTimestamp(2 + count_tDBOutput_8,
											new java.sql.Timestamp(row8.date.getTime()));
								} else {
								...
								if (row8.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_8.setString(3 + count_tDBOutput_8, row8.hashtag);
								}

								if (row8.country == null) {
									pstmtUpdate_tDBOutput_8.setNull(4 + count_tDBOutput_8, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_8.setString(4 + count_tDBOutput_8, row8.country);
								}

								try {

									updatedCount_tDBOutput_8 = updatedCount_tDBOutput_8
											+ pstmtUpdate_tDBOutput_8.executeUpdate();
									nb_line_tDBOutput_8++;
								...
								if (row8.date != null) {
									pstmtInsert_tDBOutput_8.setTimestamp(1,
											new java.sql.Timestamp(row8.date.getTime()));
								} else {
								...
								if (row8.hashtag == null) {
									...
									pstmtInsert_tDBOutput_8.setString(2, row8.hashtag);
								}

								if (row8.country == null) {
									pstmtInsert_tDBOutput_8.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_8.setString(3, row8.country);
								}

								if (row8.s_positivos == null) {
									pstmtInsert_tDBOutput_8.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_8.setInt(4, row8.s_positivos);
								}

								try {

									insertedCount_tDBOutput_8 = insertedCount_tDBOutput_8
											+ pstmtInsert_tDBOutput_8.executeUpdate();
									nb_line_tDBOutput_8++;
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_in.csv") instanceof java.io.InputStream)) {
			...
			try {
				...
				try {
					if (resourceMap.get("statementClosed_tDBOutput_8") == null) {
						...
						if ((pstmtUpdateToClose_tDBOutput_8 = (java.sql.PreparedStatement) resourceMap
								.remove("pstmtUpdate_tDBOutput_8")) != null) {
							pstmtUpdateToClose_tDBOutput_8.close();
						}
						java.sql.PreparedStatement pstmtInsertToClose_tDBOutput_8 = null;
						if ((pstmtInsertToClose_tDBOutput_8 = (java.sql.PreparedStatement) resourceMap
								.remove("pstmtInsert_tDBOutput_8")) != null) {
	...
	public void tFileInputDelimited_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_9 = "jdbc:postgresql://" + context.connection_postgres_Server + ":"
						+ context.connection_postgres_Port + "/" + context.connection_postgres_Database + "?"
						+ context.connection_postgres_AdditionalParams;
				...
				try (java.sql.ResultSet rsTable_tDBOutput_9 = dbMetaData_tDBOutput_9.getTables(null, null, null,
						new String[] { "TABLE" })) {
					String defaultSchema_tDBOutput_9 = "public";
					if (dbschema_tDBOutput_9 == null || dbschema_tDBOutput_9.trim().length() == 0) {
						try (java.sql.Statement stmtSchema_tDBOutput_9 = conn_tDBOutput_9.createStatement();
								java.sql.ResultSet rsSchema_tDBOutput_9 = stmtSchema_tDBOutput_9
										.executeQuery("select current_schema() ")) {
					...
					while (rsTable_tDBOutput_9.next()) {
						...
						if (table_tDBOutput_9.equals(("fait_tweet")) && (schema_tDBOutput_9.equals(dbschema_tDBOutput_9)
								|| ((dbschema_tDBOutput_9 == null || dbschema_tDBOutput_9.trim().length() == 0)
										&& defaultSchema_tDBOutput_9.equals(schema_tDBOutput_9)))) {
				...
				if (!whetherExist_tDBOutput_9) {
					try (java.sql.Statement stmtCreate_tDBOutput_9 = conn_tDBOutput_9.createStatement()) {
						stmtCreate_tDBOutput_9.execute("CREATE TABLE \"" + tableName_tDBOutput_9
								+ "\"(\"date\" TIMESTAMP(10)  ,\"hashtag\" VARCHAR(13)  ,\"country\" VARCHAR(10)  ,\"t_reception\" INT4 ,primary key(\"date\",\"hashtag\",\"country\"))");
					}
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_9 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_in.csv";
					...
					try {
						fid_tFileInputDelimited_9 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_in.csv",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_9.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"t_reception", "row9", temp, ex_tFileInputDelimited_9),
...
// Start of branch "row9"
						if (row9 != null) {
							...
							if (row9.hashtag == null) {
								...
								pstmt_tDBOutput_9.setString(2, row9.hashtag);
							}

							if (row9.country == null) {
								pstmt_tDBOutput_9.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_9.setString(3, row9.country);
							}
							...
							if (checkCount_tDBOutput_9 > 0) {
								if (row9.t_reception == null) {
									...
									pstmtUpdate_tDBOutput_9.setInt(1, row9.t_reception);
								}

								if (row9.date != null) {
									pstmtUpdate_tDBOutput_9.setTimestamp(2 + count_tDBOutput_9,
											new java.sql.Timestamp(row9.date.getTime()));
								} else {
								...
								if (row9.hashtag == null) {
									...
									pstmtUpdate_tDBOutput_9.setString(3 + count_tDBOutput_9, row9.hashtag);
								}

								if (row9.country == null) {
									pstmtUpdate_tDBOutput_9.setNull(4 + count_tDBOutput_9, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_9.setString(4 + count_tDBOutput_9, row9.country);
								}

								try {

									updatedCount_tDBOutput_9 = updatedCount_tDBOutput_9
											+ pstmtUpdate_tDBOutput_9.executeUpdate();
									nb_line_tDBOutput_9++;
								...
								if (row9.date != null) {
									pstmtInsert_tDBOutput_9.setTimestamp(1,
											new java.sql.Timestamp(row9.date.getTime()));
								} else {
								...
								if (row9.hashtag == null) {
									...
									pstmtInsert_tDBOutput_9.setString(2, row9.hashtag);
								}

								if (row9.country == null) {
									pstmtInsert_tDBOutput_9.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_9.setString(3, row9.country);
								}

								if (row9.t_reception == null) {
									pstmtInsert_tDBOutput_9.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_9.setInt(4, row9.t_reception);
								}

								try {

									insertedCount_tDBOutput_9 = insertedCount_tDBOutput_9
											+ pstmtInsert_tDBOutput_9.executeUpdate();
									nb_line_tDBOutput_9++;
					...
					if (!((Object) ("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_in.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s6_telechargement_mesures_dedans_dw.class.getClassLoader()
					.getResourceAsStream("analysis_twitter/s6_telechargement_mesures_dedans_dw_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = s6_telechargement_mesures_dedans_dw.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s6_telechargement_mesures_dedans_dw");
		}
...
/************************************************************************************************
 * 287539 characters generated by Talend Open Studio for Big Data on the
 * December 7, 2020 8:54:53 PM CET
 ************************************************************************************************/