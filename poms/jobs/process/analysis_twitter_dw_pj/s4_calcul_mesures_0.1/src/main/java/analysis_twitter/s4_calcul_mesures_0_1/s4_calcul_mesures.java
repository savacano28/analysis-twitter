...
package analysis_twitter.s4_calcul_mesures_0_1;
...
/**
 * Job: s4_calcul_mesures Purpose: s4_calcul_mesures<br>
 * Description: s4_calcul_mesures <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s4_calcul_mesures implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s4_calcul_mesures";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s4_calcul_mesures.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s4_calcul_mesures.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s4_calcul_mesures = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s4_calcul_mesures = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s4_calcul_mesures.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s4_calcul_mesures.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s4_calcul_mesures = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s4_calcul_mesures = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s4_calcul_mesures, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s4_calcul_mesures, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s4_calcul_mesures) {
 ...
 */
	...
	String titletMsgBox_1 = "Et 4 : Calcul des mesures";
	String messagetMsgBox_1 = "Mesures calculées";   	
 ...
 */
    ...
    public static void main(String[] args){
        final s4_calcul_mesures s4_calcul_mesuresClass = new s4_calcul_mesures();

        int exitCode = s4_calcul_mesuresClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s4_calcul_mesures.class.getClassLoader().getResourceAsStream("analysis_twitter/s4_calcul_mesures_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s4_calcul_mesures.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s4_calcul_mesures");
        }
...
/************************************************************************************************
 *     89325 characters generated by Talend Open Studio for Big Data 
