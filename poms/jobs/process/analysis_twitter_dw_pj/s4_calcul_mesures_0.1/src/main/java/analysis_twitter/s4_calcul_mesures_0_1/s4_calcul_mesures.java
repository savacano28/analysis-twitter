...
public class s4_calcul_mesures implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s4_calcul_mesures.class.getClassLoader().getResourceAsStream(
					"analysis_twitter/s4_calcul_mesures_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = s4_calcul_mesures.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : s4_calcul_mesures");
		}
...
/************************************************************************************************
 * 87461 characters generated by Talend Open Studio for Big Data on the December
 * 7, 2020 8:18:49 PM CET
 ************************************************************************************************/