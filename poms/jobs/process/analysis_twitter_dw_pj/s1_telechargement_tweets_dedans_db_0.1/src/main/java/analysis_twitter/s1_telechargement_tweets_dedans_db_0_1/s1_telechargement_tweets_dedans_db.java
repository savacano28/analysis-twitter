...
/**
 * Job: s1_telechargement_tweets_dedans_db Purpose:
 * s1_telechargement_tweets_dedans_db<br>
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(s1_telechargement_tweets_dedans_db.this,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db.length) {
					if (length < 1024
							&& commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db.length == 0) {
				...
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
...
// Start of branch "row6"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s1_telechargement_tweets_dedans_db.class.getClassLoader()
					.getResourceAsStream("analysis_twitter/s1_telechargement_tweets_dedans_db_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = s1_telechargement_tweets_dedans_db.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s1_telechargement_tweets_dedans_db");
		}
...
/************************************************************************************************
 * 253581 characters generated by Talend Open Studio for Big Data on the
 * December 7, 2020 8:07:58 PM CET
 ************************************************************************************************/