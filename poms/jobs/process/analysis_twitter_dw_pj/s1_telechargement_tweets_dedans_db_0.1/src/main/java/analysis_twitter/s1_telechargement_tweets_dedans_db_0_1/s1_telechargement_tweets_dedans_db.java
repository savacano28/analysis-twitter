...
package analysis_twitter.s1_telechargement_tweets_dedans_db_0_1;
...
/**
 * Job: s1_telechargement_tweets_dedans_db Purpose: s1_telechargement_tweets_dedans_db<br>
 * Description: s1_telechargement_tweets_dedans_db <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s1_telechargement_tweets_dedans_db implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s1_telechargement_tweets_dedans_db";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s1_telechargement_tweets_dedans_db.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s1_telechargement_tweets_dedans_db.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s1_telechargement_tweets_dedans_db) {
 ...
 */
	...
	String titletMsgBox_1 = "Et 1 : Téléchargement des tweets dedans de la base de données";
	String messagetMsgBox_1 = "Les données de tweets ont été télechargés";   	
 ...
 */
    ...
    public static void main(String[] args){
        final s1_telechargement_tweets_dedans_db s1_telechargement_tweets_dedans_dbClass = new s1_telechargement_tweets_dedans_db();

        int exitCode = s1_telechargement_tweets_dedans_dbClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s1_telechargement_tweets_dedans_db.class.getClassLoader().getResourceAsStream("analysis_twitter/s1_telechargement_tweets_dedans_db_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s1_telechargement_tweets_dedans_db.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s1_telechargement_tweets_dedans_db");
        }
...
/************************************************************************************************
 *     259760 characters generated by Talend Open Studio for Big Data 
