	...
	currentComponent="tUniqRow_4";
		...
		class KeyStruct_tUniqRow_4 {
		    ...
		    public boolean hashCodeDirty = true;
					...
					java.util.Date date_description;        
...
row5 = null;			
finder_tUniqRow_4.date_description = dim_date.date_description;	
...
new_tUniqRow_4.date_description = dim_date.date_description;
 ...
 */
	...
	String titletMsgBox_1 = "Et 2 : Téléchargement des dimension dedans de dw";
	String messagetMsgBox_1 = "Les dimensions ont été téléchargés";   	
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
                ...
                private void processContext_0() {
                        ...
                        context.setContextType("connection_postgres_Password", "id_Password");
                            ...
                            if(pwd_connection_postgres_Password_value!=null) {
                                if(context_param.containsKey("connection_postgres_Password")) {//no need to decrypt if it come from program argument or parent job runtime
                                    ...
                                    try {
                                        context.connection_postgres_Password = routines.system.PasswordEncryptUtil.decryptPassword(pwd_connection_postgres_Password_value);
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("connection_postgres_Port")) {
                ...
                context.connection_postgres_Password = (java.lang.String) parentContextMap.get("connection_postgres_Password");
...
/************************************************************************************************
 *     173749 characters generated by Talend Open Studio for Big Data 
