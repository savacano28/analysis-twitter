...
/**
 * Job: s2_telechargement_donnees_dedans_dw Purpose:
 * s2_telechargement_donnees_dedans_dw<br>
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(s2_telechargement_donnees_dedans_dw.this,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dedans_dw.length) {
					if (length < 1024
							&& commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dedans_dw.length == 0) {
				...
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dedans_dw, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("dim_user")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"user_id\" VARCHAR(50)   not null ,\"user_name\" VARCHAR(100)  ,\"user_screen_name\" VARCHAR(100)  ,\"user_location\" VARCHAR(500)  ,\"user_description\" VARCHAR(1000)  ,primary key(\"user_id\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"user_id\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"user_id\",\"user_name\",\"user_screen_name\",\"user_location\",\"user_description\") VALUES (?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"user_name\" = ?,\"user_screen_name\" = ?,\"user_location\" = ?,\"user_description\" = ? WHERE \"user_id\" = ?";
				...
				if (!whetherExist_tDBOutput_2) {
					try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
						stmtCreate_tDBOutput_2.execute("CREATE TABLE \"" + tableName_tDBOutput_2
								+ "\"(\"hashtag_id\" VARCHAR(50)   not null ,\"hashtag\" VARCHAR(50)  ,primary key(\"hashtag\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_2 + "\" WHERE \"hashtag\" = ?");
				resourceMap.put("pstmt_tDBOutput_2", pstmt_tDBOutput_2);
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2
						+ "\" (\"hashtag_id\",\"hashtag\") VALUES (?,?)";
				...
				try (java.sql.ResultSet rsTable_tDBOutput_5 = dbMetaData_tDBOutput_5.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_5.next()) {
						...
						if (table_tDBOutput_5.equals(("dim_text")) && (schema_tDBOutput_5.equals(dbschema_tDBOutput_5)
				...
				if (!whetherExist_tDBOutput_5) {
					try (java.sql.Statement stmtCreate_tDBOutput_5 = conn_tDBOutput_5.createStatement()) {
						stmtCreate_tDBOutput_5.execute("CREATE TABLE \"" + tableName_tDBOutput_5
								+ "\"(\"text_id\" VARCHAR(50)   not null ,\"text_description\" VARCHAR(500)  ,primary key(\"text_description\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_5 = conn_tDBOutput_5.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_5 + "\" WHERE \"text_description\" = ?");
				resourceMap.put("pstmt_tDBOutput_5", pstmt_tDBOutput_5);
				String insert_tDBOutput_5 = "INSERT INTO \"" + tableName_tDBOutput_5
						+ "\" (\"text_id\",\"text_description\") VALUES (?,?)";
				...
				String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5
						+ "\" SET \"text_id\" = ? WHERE \"text_description\" = ?";
				...
				class KeyStruct_tUniqRow_5 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.text_description == null) ? 0 : this.text_description.hashCode());
				...
				try (java.sql.ResultSet rsTable_tDBOutput_4 = dbMetaData_tDBOutput_4.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_4.next()) {
						...
						if (table_tDBOutput_4.equals(("dim_date")) && (schema_tDBOutput_4.equals(dbschema_tDBOutput_4)
				...
				if (!whetherExist_tDBOutput_4) {
					try (java.sql.Statement stmtCreate_tDBOutput_4 = conn_tDBOutput_4.createStatement()) {
						stmtCreate_tDBOutput_4.execute("CREATE TABLE \"" + tableName_tDBOutput_4
								+ "\"(\"date_id\" VARCHAR(50)   not null ,\"date_description\" DATE ,primary key(\"date_description\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_4 = conn_tDBOutput_4.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_4 + "\" WHERE \"date_description\" = ?");
				resourceMap.put("pstmt_tDBOutput_4", pstmt_tDBOutput_4);
				String insert_tDBOutput_4 = "INSERT INTO \"" + tableName_tDBOutput_4
						+ "\" (\"date_id\",\"date_description\") VALUES (?,?)";
				...
				String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4
						+ "\" SET \"date_id\" = ? WHERE \"date_description\" = ?";
				...
				if (!whetherExist_tDBOutput_3) {
					try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
						stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3
								+ "\"(\"geo_id\" VARCHAR(50)   not null ,\"country\" VARCHAR(50)  ,primary key(\"country\"))");
					}
				}
				String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3
						+ "\" SET \"geo_id\" = ? WHERE \"country\" = ?";
...
// Start of branch "dim_user"
						if (dim_user != null) {
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								row2.user_id = dim_user.user_id;
								row2.user_name = dim_user.user_name;
								row2.user_screen_name = dim_user.user_screen_name;
								row2.user_location = dim_user.user_location;
								row2.user_description = dim_user.user_description;
...
// Start of branch "row2"
							if (row2 != null) {
								...
								if (row2.user_id == null) {
									...
									pstmt_tDBOutput_1.setString(1, row2.user_id);
								}
								...
								if (checkCount_tDBOutput_1 > 0) {
									if (row2.user_name == null) {
										...
										pstmtUpdate_tDBOutput_1.setString(1, row2.user_name);
									}

									if (row2.user_screen_name == null) {
										pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(2, row2.user_screen_name);
									}

									if (row2.user_location == null) {
										pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(3, row2.user_location);
									}

									if (row2.user_description == null) {
										pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(4, row2.user_description);
									}

									if (row2.user_id == null) {
										pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, row2.user_id);
									}
									...
									if (row2.user_id == null) {
										...
										pstmtInsert_tDBOutput_1.setString(1, row2.user_id);
									}

									if (row2.user_name == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(2, row2.user_name);
									}

									if (row2.user_screen_name == null) {
										pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(3, row2.user_screen_name);
									}

									if (row2.user_location == null) {
										pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(4, row2.user_location);
									}

									if (row2.user_description == null) {
										pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(5, row2.user_description);
									}
...
// Start of branch "dim_hashtag"
						if (dim_hashtag != null) {
							...
							if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
								...
								row3.hashtag_id = dim_hashtag.hashtag_id;
								row3.hashtag = dim_hashtag.hashtag;
...
// Start of branch "row3"
							if (row3 != null) {
								...
								if (row3.hashtag == null) {
									...
									pstmt_tDBOutput_2.setString(1, row3.hashtag);
								}
								...
								if (checkCount_tDBOutput_2 > 0) {
									if (row3.hashtag_id == null) {
										...
										pstmtUpdate_tDBOutput_2.setString(1, row3.hashtag_id);
									}

									if (row3.hashtag == null) {
										pstmtUpdate_tDBOutput_2.setNull(2 + count_tDBOutput_2, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_2.setString(2 + count_tDBOutput_2, row3.hashtag);
									}
									...
									if (row3.hashtag_id == null) {
										...
										pstmtInsert_tDBOutput_2.setString(1, row3.hashtag_id);
									}

									if (row3.hashtag == null) {
										pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_2.setString(2, row3.hashtag);
									}
...
// Start of branch "dim_text"
						if (dim_text != null) {
							...
							if (!keystUniqRow_5.contains(finder_tUniqRow_5)) {
								...
								row6.text_id = dim_text.text_id;
								row6.text_description = dim_text.text_description;
...
// Start of branch "row6"
							if (row6 != null) {
								...
								if (row6.text_description == null) {
									...
									pstmt_tDBOutput_5.setString(1, row6.text_description);
								}
								...
								if (checkCount_tDBOutput_5 > 0) {
									if (row6.text_id == null) {
										...
										pstmtUpdate_tDBOutput_5.setString(1, row6.text_id);
									}

									if (row6.text_description == null) {
										pstmtUpdate_tDBOutput_5.setNull(2 + count_tDBOutput_5, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_5.setString(2 + count_tDBOutput_5, row6.text_description);
									}
									...
									if (row6.text_id == null) {
										...
										pstmtInsert_tDBOutput_5.setString(1, row6.text_id);
									}

									if (row6.text_description == null) {
										pstmtInsert_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_5.setString(2, row6.text_description);
									}
...
// Start of branch "dim_date"
						if (dim_date != null) {
							...
							row5.date_id = dim_date.date_id;
							row5.date_description = dim_date.date_description;
...
// Start of branch "row5"
							if (row5 != null) {
								...
								if (row5.date_description != null) {
									pstmt_tDBOutput_4.setTimestamp(1,
											new java.sql.Timestamp(row5.date_description.getTime()));
								} else {
								...
								if (checkCount_tDBOutput_4 > 0) {
									if (row5.date_id == null) {
										...
										pstmtUpdate_tDBOutput_4.setString(1, row5.date_id);
									}
									...
									if (row5.date_description != null) {
										...
										pstmtUpdate_tDBOutput_4.setNull(2 + count_tDBOutput_4,
									...
									if (row5.date_id == null) {
										...
										pstmtInsert_tDBOutput_4.setString(1, row5.date_id);
									}
...
// Start of branch "dim_country"
						if (dim_country != null) {
							...
							if (!keystUniqRow_3.contains(finder_tUniqRow_3)) {
								...
								row4.geo_id = dim_country.geo_id;
								row4.country = dim_country.country;
...
// Start of branch "row4"
							if (row4 != null) {
								...
								if (row4.geo_id == null) {
									...
									pstmtUpdate_tDBOutput_3.setString(1, row4.geo_id);
								}

								if (row4.country == null) {
									pstmtUpdate_tDBOutput_3.setNull(2 + count_tDBOutput_3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_3.setString(2 + count_tDBOutput_3, row4.country);
								}
								...
								try {
									...
									if (updateFlag_tDBOutput_3 == 0) {
										...
										if (row4.geo_id == null) {
											...
											pstmtInsert_tDBOutput_3.setString(1, row4.geo_id);
										}

										if (row4.country == null) {
											pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmtInsert_tDBOutput_3.setString(2, row4.country);
										}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s2_telechargement_donnees_dedans_dw.class.getClassLoader()
					.getResourceAsStream("analysis_twitter/s2_telechargement_donnees_dedans_dw_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = s2_telechargement_donnees_dedans_dw.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s2_telechargement_donnees_dedans_dw");
		}
...
/************************************************************************************************
 * 172815 characters generated by Talend Open Studio for Big Data on the
 * December 7, 2020 8:13:21 PM CET
 ************************************************************************************************/