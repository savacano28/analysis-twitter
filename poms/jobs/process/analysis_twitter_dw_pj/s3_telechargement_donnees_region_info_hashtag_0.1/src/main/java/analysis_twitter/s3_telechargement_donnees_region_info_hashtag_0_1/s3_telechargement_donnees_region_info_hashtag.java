...
package analysis_twitter.s3_telechargement_donnees_region_info_hashtag_0_1;
...
/**
 * Job: s3_telechargement_donnees_region_info_hashtag Purpose: s3_telechargement_données_region_info_hashtag<br>
 * Description: s3_telechargement_données_region_info_hashtag <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s3_telechargement_donnees_region_info_hashtag implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s3_telechargement_donnees_region_info_hashtag";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s3_telechargement_donnees_region_info_hashtag.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s3_telechargement_donnees_region_info_hashtag.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag) {
...
public static class hashtag_infoStruct implements routines.system.IPersistableRow<hashtag_infoStruct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(hashtag_infoStruct other) {
...
hashtag_infoStruct hashtag_info = new hashtag_infoStruct();
 ...
 */
	...
	currentComponent="tUniqRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"hashtag_info");
					}
...
hashtag_infoStruct hashtag_info_tmp = new hashtag_infoStruct();
...
hashtag_info_tmp.hashtag = row1.hashtag ;
hashtag_info_tmp.text = row1.hashtag_description ;
hashtag_info = hashtag_info_tmp;
...
regions_tmp.localisation = row1.geo ;
regions = regions_tmp;
} // closing filter/reject
// ###############################
 ...
 */
// Start of branch "hashtag_info"
if(hashtag_info != null) { 
	...
	currentComponent="tUniqRow_2";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"hashtag_info");
					}
					
row2 = null;			
if(hashtag_info.text == null){
	finder_tUniqRow_2.text = null;
}else{
	finder_tUniqRow_2.text = hashtag_info.text.toLowerCase();
}	
...
if(hashtag_info.text == null){
	...
	new_tUniqRow_2.text = hashtag_info.text.toLowerCase();
}
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.hashtag = hashtag_info.hashtag;			row2.text = hashtag_info.text;					
...
row3.country = regions.country;			row3.localisation = regions.localisation;			
...
globalMap.put("tUniqRow_2_NB_DUPLICATES",nb_duplicates_tUniqRow_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"hashtag_info");
			  	}
 ...
 */
	...
	String titletMsgBox_1 = "Et 3 : Téléchargement hierarchies dedans dw";
	String messagetMsgBox_1 = "Téléchargement hierarchies dedans dw";   	
 ...
 */
    ...
    public static void main(String[] args){
        final s3_telechargement_donnees_region_info_hashtag s3_telechargement_donnees_region_info_hashtagClass = new s3_telechargement_donnees_region_info_hashtag();

        int exitCode = s3_telechargement_donnees_region_info_hashtagClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s3_telechargement_donnees_region_info_hashtag.class.getClassLoader().getResourceAsStream("analysis_twitter/s3_telechargement_donnees_region_info_hashtag_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s3_telechargement_donnees_region_info_hashtag.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s3_telechargement_donnees_region_info_hashtag");
        }
...
/************************************************************************************************
 *     100351 characters generated by Talend Open Studio for Big Data 
 *     on the December 6, 2020 10:01:43 PM CET
 ************************************************************************************************/