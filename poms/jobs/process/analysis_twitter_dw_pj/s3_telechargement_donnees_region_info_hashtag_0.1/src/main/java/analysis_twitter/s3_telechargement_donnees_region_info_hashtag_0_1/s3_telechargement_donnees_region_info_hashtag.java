...
/**
 * Job: s3_telechargement_donnees_region_info_hashtag Purpose:
 * s3_telechargement_données_region_info_hashtag<br>
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(s3_telechargement_donnees_region_info_hashtag.this,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag.length) {
					if (length < 1024
							&& commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag.length == 0) {
						commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[1024];
					} else {
						commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag = new byte[2
								* length];
					}
				}
				dis.readFully(commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag, 0,
						length);
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s3_telechargement_donnees_region_info_hashtag,
...
// Start of branch "hashtag_info"
						if (hashtag_info != null) {
							...
							if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
								...
								row2.hashtag = hashtag_info.hashtag;
								row2.text = hashtag_info.text;
...
// Start of branch "regions"
						if (regions != null) {
							...
							row3.country = regions.country;
							row3.localisation = regions.localisation;
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s3_telechargement_donnees_region_info_hashtag.class.getClassLoader()
					.getResourceAsStream("analysis_twitter/s3_telechargement_donnees_region_info_hashtag_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = s3_telechargement_donnees_region_info_hashtag.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s3_telechargement_donnees_region_info_hashtag");
		}
...
/************************************************************************************************
 * 94195 characters generated by Talend Open Studio for Big Data on the December
 * 7, 2020 8:15:54 PM CET
 ************************************************************************************************/