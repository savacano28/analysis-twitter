	...
	public static class coronaWarnAPPStruct implements routines.system.IPersistableRow<coronaWarnAPPStruct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s0_connexion_api_twitter, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
				...
				try {
					...
					if (use_auth_tRESTClient_1 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:j8A8RbN6ra9dAlrMQsx3fBLMPe8wmegBH8FgPrDIwB6Htfeq");
					...
					if (use_auth_tRESTClient_1 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:csidZlWIx41MZFytOuNj8RHvFPcTdy6oiK8OVH5g2cF4OU9D");
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:clY+JGw9LdwBqASmu0zE+zLWysChG6/TeXEHBelHYpGpGvqD");
					...
					if (use_auth_tRESTClient_1 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:9al281HtjdMD07ONtMCELWB5fvXDRYTg/BpJbRM7+FfEdw3S");
				...
				try {
					...
					if (use_auth_tRESTClient_2 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:paLPEy+VLMu1pNZ1zsGgrEchiFRHmc/WOsINXmOWkEBF5i41");
					...
					if (use_auth_tRESTClient_2 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:baCXmtTGOsRVzTg6GEPLum4h/OBPER4cStx5LzsYgNYoIAN9");
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:7kY4jOFUQkO1jHRVo+bp4cgmyz382s/XgYCA5fpJuAhWyyuw");
					...
					if (use_auth_tRESTClient_2 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:BCBHiz27e2dmTPcTua8YH/YO7RBYYkrFatMczQtYRiR5VSw6");
				...
				try {
					...
					if (use_auth_tRESTClient_3 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:OITpsDW2N2ovs8T+zuaWCdDz/3kNQX2oyokIizYsLQmMnSgD");
					...
					if (use_auth_tRESTClient_3 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:fg2no434ABu+CzW3tTSQ5ZpFVz9ZGhqPhs2lPmer3jy35aLI");
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:232jBti/bruHBqft8qUocjnLuLooTy7eycVf+NnuVY7IfwN1");
					...
					if (use_auth_tRESTClient_3 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:AW3scU7u2KJatQiBzWIS/NgSkXAQuqDe6TbPPF6vdc3vtHqs");
...
// Start of branch "nhs"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s0_connexion_api_twitter.class.getClassLoader().getResourceAsStream(
					"analysis_twitter/s0_connexion_api_twitter_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = s0_connexion_api_twitter.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s0_connexion_api_twitter");
		}
...
/************************************************************************************************
 * 163085 characters generated by Talend Open Studio for Big Data on the
 * December 6, 2020 9:52:09 PM CET
 ************************************************************************************************/