...
/**
 * Job: s5_fr_calcul_sentiments_depuis_donnees_tweets Purpose:
 * s5_fr_calcul_sentiments_depuis_donnees_tweets<br>
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(s5_fr_calcul_sentiments_depuis_donnees_tweets.this,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets.length) {
					if (length < 1024
							&& commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets.length == 0) {
						commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[1024];
					} else {
						commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[2
								* length];
					}
				}
				dis.readFully(commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets, 0,
						length);
				strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets,
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/liste_mots_sentiments/AFINN-111.txt",
...
// Start of branch "row6"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = s5_fr_calcul_sentiments_depuis_donnees_tweets.class.getClassLoader()
					.getResourceAsStream("analysis_twitter/s5_fr_calcul_sentiments_depuis_donnees_tweets_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = s5_fr_calcul_sentiments_depuis_donnees_tweets.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : s5_fr_calcul_sentiments_depuis_donnees_tweets");
		}
...
/************************************************************************************************
 * 240094 characters generated by Talend Open Studio for Big Data on the
 * December 7, 2020 8:21:07 PM CET
 ************************************************************************************************/