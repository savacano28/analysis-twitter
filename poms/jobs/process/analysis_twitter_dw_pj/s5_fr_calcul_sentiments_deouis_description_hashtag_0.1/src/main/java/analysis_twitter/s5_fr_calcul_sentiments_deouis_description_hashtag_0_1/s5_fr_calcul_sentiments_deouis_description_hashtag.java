...
package analysis_twitter.s5_fr_calcul_sentiments_deouis_description_hashtag_0_1;
...
/**
 * Job: s5_fr_calcul_sentiments_deouis_description_hashtag Purpose: s5_fr_calcul_sentiments_deouis_description_hashtag<br>
 * Description: s5_fr_calcul_sentiments_deouis_description_hashtag <br>
 * @author 
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s5_fr_calcul_sentiments_deouis_description_hashtag implements TalendJob {
...
public String getConnection_postgres_Login(){
	...
	private final String jobName = "s5_fr_calcul_sentiments_deouis_description_hashtag";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s5_fr_calcul_sentiments_deouis_description_hashtag.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s5_fr_calcul_sentiments_deouis_description_hashtag.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_deouis_description_hashtag) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.connection_postgres_Password; 
		    ...
		    String dbquery_tDBInput_1 = "select id,to_char(date,'dd-MM-yyyy') as date,hashtag,country,hashtag_description from all_tweets where country = 'Franc"
+"e';";
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_sum_fr.csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_pos_fr.csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/mesures/sent_neg_fr.csv")).getAbsolutePath().replace("\\","/");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row5,row6) outputs:(out2,pos,neg)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/liste_mots_sentiments/AFINN-111.txt";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/liste_mots_sentiments/AFINN-111.txt", "UTF-8",",","\n",false,0,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/home/scasanova/Downloads/TOS_BD-20200219_1130-V7.3.1/workspace/ANALYSIS_TWITTER/documentations/liste_mots_sentiments/AFINN-111.txt") instanceof java.io.InputStream)){
 ...
 */
	...
	String titletMsgBox_1 = "Et 5 : Calcul de sentiments";
	String messagetMsgBox_1 = "Calcul de sentiments sur les textes des tweets";   	
 ...
 */
    ...
    public static void main(String[] args){
        final s5_fr_calcul_sentiments_deouis_description_hashtag s5_fr_calcul_sentiments_deouis_description_hashtagClass = new s5_fr_calcul_sentiments_deouis_description_hashtag();

        int exitCode = s5_fr_calcul_sentiments_deouis_description_hashtagClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s5_fr_calcul_sentiments_deouis_description_hashtag.class.getClassLoader().getResourceAsStream("analysis_twitter/s5_fr_calcul_sentiments_deouis_description_hashtag_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s5_fr_calcul_sentiments_deouis_description_hashtag.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s5_fr_calcul_sentiments_deouis_description_hashtag");
        }
...
/************************************************************************************************
 *     246055 characters generated by Talend Open Studio for Big Data 
