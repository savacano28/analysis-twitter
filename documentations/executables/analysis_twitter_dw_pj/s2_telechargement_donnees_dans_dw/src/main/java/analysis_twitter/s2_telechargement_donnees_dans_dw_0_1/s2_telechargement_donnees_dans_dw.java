...
package analysis_twitter.s2_telechargement_donnees_dans_dw_0_1;
...
/**
 * Job: s2_telechargement_donnees_dans_dw Purpose: s2_telechargement_donnees_dans_dw<br>
 * Description: s2_telechargement_donnees_dans_dw <br>
 * @author 
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s2_telechargement_donnees_dans_dw implements TalendJob {
...
public String getPath_files_global(){
	...
	private final String jobName = "s2_telechargement_donnees_dans_dw";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s2_telechargement_donnees_dans_dw.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s2_telechargement_donnees_dans_dw.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s2_telechargement_donnees_dans_dw) {
 ...
 */
    ...
    public static void main(String[] args){
        final s2_telechargement_donnees_dans_dw s2_telechargement_donnees_dans_dwClass = new s2_telechargement_donnees_dans_dw();

        int exitCode = s2_telechargement_donnees_dans_dwClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s2_telechargement_donnees_dans_dw.class.getClassLoader().getResourceAsStream("analysis_twitter/s2_telechargement_donnees_dans_dw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s2_telechargement_donnees_dans_dw.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s2_telechargement_donnees_dans_dw");
        }
...
/************************************************************************************************
 *     171371 characters generated by Talend Open Studio for Big Data 
 *     on the December 12, 2020 5:05:17 PM CET
 ************************************************************************************************/