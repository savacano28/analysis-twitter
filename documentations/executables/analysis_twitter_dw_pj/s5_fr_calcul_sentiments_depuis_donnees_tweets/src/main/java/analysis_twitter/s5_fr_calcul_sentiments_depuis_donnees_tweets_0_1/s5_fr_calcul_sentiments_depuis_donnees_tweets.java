...
package analysis_twitter.s5_fr_calcul_sentiments_depuis_donnees_tweets_0_1;
...
/**
 * Job: s5_fr_calcul_sentiments_depuis_donnees_tweets Purpose: s5_fr_calcul_sentiments_depuis_donnees_tweets<br>
 * Description: s5_fr_calcul_sentiments_depuis_donnees_tweets <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class s5_fr_calcul_sentiments_depuis_donnees_tweets implements TalendJob {
...
public String getPath_files_global(){
	...
	private final String jobName = "s5_fr_calcul_sentiments_depuis_donnees_tweets";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				s5_fr_calcul_sentiments_depuis_donnees_tweets.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(s5_fr_calcul_sentiments_depuis_donnees_tweets.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row112Struct implements routines.system.IPersistableRow<row112Struct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets.length) {
				if(length < 1024 && commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets.length == 0) {
   					commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[1024];
				} else {
   					commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets, 0, length);
			strReturn = new String(commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets) {
...
public static class c_frStruct implements routines.system.IPersistableRow<c_frStruct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(c_frStruct other) {
...
public static class c_posStruct implements routines.system.IPersistableRow<c_posStruct> {
    final static byte[] commonByteArrayLock_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[0];
    static byte[] commonByteArray_ANALYSIS_TWITTER_s5_fr_calcul_sentiments_depuis_donnees_tweets = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(c_posStruct other) {
 ...
 */
	...
	currentComponent="tAggregateRow_4_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"c_pos");
					}
...
c_posStruct c_pos_tmp = new c_posStruct();
// ###############################
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.word_french = '" + row6HashKey.word_french + "'");
								} // G 071
...
// # Output table : 'c_pos'
c_pos_tmp.date = TalendDate.formatDate("dd-MM-yyyy",row5.date);
c_pos_tmp.id = row5.id ;
c_pos_tmp.hashtag = row5.hashtag ;
c_pos_tmp.country = row5.country ;
c_pos_tmp.sentiment = row6.sentiment ;
c_pos = c_pos_tmp;
// ###############################
...
if(c_pos != null) { 
	...
	currentComponent="tAggregateRow_4_AGGOUT";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"c_pos");
					}
					
	
operation_finder_tAggregateRow_4.date = c_pos.date;
			operation_finder_tAggregateRow_4.id = c_pos.id;
			operation_finder_tAggregateRow_4.hashtag = c_pos.hashtag;
			operation_finder_tAggregateRow_4.country = c_pos.country;
	...
	if(operation_result_tAggregateRow_4 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_4.put(operation_result_tAggregateRow_4, operation_result_tAggregateRow_4);
					...
					if( c_pos.sentiment != null)
						operation_result_tAggregateRow_4.sentiment_sum += c_pos.sentiment;
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File(context.path_files_global+"documentations/mesures/sent_sum_fr.csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.path_files_global+"documentations/mesures/sent_pos_fr.csv")).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.path_files_global+"documentations/mesures/sent_neg_fr.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tAggregateRow_4_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"c_pos");
			  	}
 ...
 */
	...
	currentComponent="tAggregateRow_7_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"c_fr");
					}
...
c_frStruct c_fr_tmp = new c_frStruct();
// ###############################
 ...
 */
	...
	currentComponent="tAggregateRow_4_AGGIN";
            				    ...
            				    String s_date_date_tAggregateRow_4 = String.valueOf(aggregated_row_tAggregateRow_4.date);
            				    row10.date = ("null").equals(s_date_date_tAggregateRow_4) ? null : ParserUtils.parseTo_Date(s_date_date_tAggregateRow_4, "dd-MM-yyyy");
...
c_fr_tmp.date = row10.date ;
c_fr_tmp.hashtag = row10.hashtag ;
c_fr_tmp.country = row10.country ;
c_fr_tmp.c_tweet = (row10.sentiment != 0?1:0);
c_fr = c_fr_tmp;
} // closing filter/reject
// ###############################
...
if(c_fr != null) { 
	...
	currentComponent="tAggregateRow_7_AGGOUT";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"c_fr");
					}
					
	
operation_finder_tAggregateRow_7.date = c_fr.date;
			operation_finder_tAggregateRow_7.hashtag = c_fr.hashtag;
			operation_finder_tAggregateRow_7.country = c_fr.country;
	...
	if(operation_result_tAggregateRow_7 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_7.put(operation_result_tAggregateRow_7, operation_result_tAggregateRow_7);
				...
				if(c_fr.c_tweet != null) { // G_OutMain_AggR_546
				
					if(operation_result_tAggregateRow_7.c_tweet_sum == null) {
						operation_result_tAggregateRow_7.c_tweet_sum = (int) 0;
					}
					
					if( c_fr.c_tweet != null)
						operation_result_tAggregateRow_7.c_tweet_sum += c_fr.c_tweet;
				} // G_OutMain_AggR_546
...
String fileName_tFileOutputDelimited_4 = "";
    fileName_tFileOutputDelimited_4 = (new java.io.File(context.path_files_global+"documentations/mesures/c_pos_fr.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tAggregateRow_5_AGGIN";
            				    ...
            				    row11.date = aggregated_row_tAggregateRow_5.date;
            				    
            				    row11.hashtag = aggregated_row_tAggregateRow_5.hashtag;
            				    
            				    row11.country = aggregated_row_tAggregateRow_5.country;
            				    row11.c_positives = aggregated_row_tAggregateRow_5.c_positives_sum;
...
String fileName_tFileOutputDelimited_5 = "";
    fileName_tFileOutputDelimited_5 = (new java.io.File(context.path_files_global+"documentations/mesures/c_neg_fr.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tAggregateRow_6_AGGIN";
            				    ...
            				    row111.date = aggregated_row_tAggregateRow_6.date;
            				    
            				    row111.hashtag = aggregated_row_tAggregateRow_6.hashtag;
            				    
            				    row111.country = aggregated_row_tAggregateRow_6.country;
            				    row111.c_negatives = aggregated_row_tAggregateRow_6.c_negatives_sum;
 ...
 */
	...
	currentComponent="tFileOutputDelimited_5";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"row111");
					}
                    ...
                    StringBuilder sb_tFileOutputDelimited_5 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_5.append(
                            FormatterUtils.format_Date(row111.date, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row111.hashtag != null) {
                        sb_tFileOutputDelimited_5.append(
                            row111.hashtag
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row111.country != null) {
                        sb_tFileOutputDelimited_5.append(
                            row111.country
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row111.c_negatives != null) {
                        sb_tFileOutputDelimited_5.append(
                            row111.c_negatives
                        );
                            }
 ...
 */
	...
	currentComponent="tAggregateRow_7_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"c_fr");
			  	}
...
String fileName_tFileOutputDelimited_6 = "";
    fileName_tFileOutputDelimited_6 = (new java.io.File(context.path_files_global+"documentations/mesures/c_fr.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tAggregateRow_7_AGGIN";
            				    ...
            				    row112.date = aggregated_row_tAggregateRow_7.date;
            				    
            				    row112.hashtag = aggregated_row_tAggregateRow_7.hashtag;
            				    
            				    row112.country = aggregated_row_tAggregateRow_7.country;
            				    row112.c_tweet = aggregated_row_tAggregateRow_7.c_tweet_sum;
 ...
 */
	...
	currentComponent="tFileOutputDelimited_6";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"row112");
					}
                    ...
                    StringBuilder sb_tFileOutputDelimited_6 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_6.append(
                            FormatterUtils.format_Date(row112.date, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row112.hashtag != null) {
                        sb_tFileOutputDelimited_6.append(
                            row112.hashtag
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row112.country != null) {
                        sb_tFileOutputDelimited_6.append(
                            row112.country
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row112.c_tweet != null) {
                        sb_tFileOutputDelimited_6.append(
                            row112.c_tweet
                        );
                            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row5,row6) outputs:(out2,pos,neg,c_pos)
 ...
 */
    ...
    public static void main(String[] args){
        final s5_fr_calcul_sentiments_depuis_donnees_tweets s5_fr_calcul_sentiments_depuis_donnees_tweetsClass = new s5_fr_calcul_sentiments_depuis_donnees_tweets();

        int exitCode = s5_fr_calcul_sentiments_depuis_donnees_tweetsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = s5_fr_calcul_sentiments_depuis_donnees_tweets.class.getClassLoader().getResourceAsStream("analysis_twitter/s5_fr_calcul_sentiments_depuis_donnees_tweets_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = s5_fr_calcul_sentiments_depuis_donnees_tweets.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : s5_fr_calcul_sentiments_depuis_donnees_tweets");
        }
...
/************************************************************************************************
 *     389437 characters generated by Talend Open Studio for Big Data 
 *     on the December 9, 2020 11:15:23 PM CET
 ************************************************************************************************/