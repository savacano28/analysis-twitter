...
package analysis_twitter.workflow_final_0_1;
...
/**
 * Job: workflow_final Purpose: workflow_final<br>
 * Description: workflow_final <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class workflow_final implements TalendJob {
...
public String getPath_files_global(){
	...
	private final String jobName = "workflow_final";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				workflow_final.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(workflow_final.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tMsgBox_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tMsgBox_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 */
	...
	String titletMsgBox_2 = "Analyse des tweets liés aux app COVID avec talend";
	String messagetMsgBox_2 = "Initialisation de la récupération et traitement des tweets liés aux apps de surveillance COVID-19";   	
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    ...
                    parentContextMap_tRunJob_2.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_2.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_2.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_2.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_2.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_2.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_2.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_2.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_2.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = context.path_files_global;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param path_files_global=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param path_files_global=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("path_files_global", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.connection_postgres_Port;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param connection_postgres_Port=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param connection_postgres_Port=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("connection_postgres_Port", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.connection_postgres_Password;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param connection_postgres_Password=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param connection_postgres_Password=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("connection_postgres_Password", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.connection_postgres_Login;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param connection_postgres_Login=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param connection_postgres_Login=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("connection_postgres_Login", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.connection_postgres_Server;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param connection_postgres_Server=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param connection_postgres_Server=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("connection_postgres_Server", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.connection_postgres_Database;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param connection_postgres_Database=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param connection_postgres_Database=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("connection_postgres_Database", obj_tRunJob_2);
	
	
		analysis_twitter.s0_connexion_api_twitter_apps_covid_0_1.s0_connexion_api_twitter_apps_covid childJob_tRunJob_2 = new analysis_twitter.s0_connexion_api_twitter_apps_covid_0_1.s0_connexion_api_twitter_apps_covid();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_1.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_1.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_1.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_1.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_1.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_1.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_1.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_1.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_1.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_1 = null;
		...
		analysis_twitter.s1_telechargement_tweets_dans_db_0_1.s1_telechargement_tweets_dans_db childJob_tRunJob_1 = new analysis_twitter.s1_telechargement_tweets_dans_db_0_1.s1_telechargement_tweets_dans_db();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_3 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_3 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_3.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_3.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_3.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_3.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_3.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_3.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_3.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_3.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_3.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_3 = null;
		...
		analysis_twitter.s2_telechargement_donnees_dans_dw_0_1.s2_telechargement_donnees_dans_dw childJob_tRunJob_3 = new analysis_twitter.s2_telechargement_donnees_dans_dw_0_1.s2_telechargement_donnees_dans_dw();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_4 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_4.add("--context=dev");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_4 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_4.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_4.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_4.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_4.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_4.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_4.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_4.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_4.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_4.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_4 = null;
		...
		analysis_twitter.s3_telechargement_donnees_region_info_hashtag_0_1.s3_telechargement_donnees_region_info_hashtag childJob_tRunJob_4 = new analysis_twitter.s3_telechargement_donnees_region_info_hashtag_0_1.s3_telechargement_donnees_region_info_hashtag();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_5 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_5.add("--context=dev");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_5 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_5 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_5.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_5.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_5.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_5.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_5.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_5.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_5.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_5.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_5.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_5 = null;
		...
		analysis_twitter.s4_calcul_mesures_0_1.s4_calcul_mesures childJob_tRunJob_5 = new analysis_twitter.s4_calcul_mesures_0_1.s4_calcul_mesures();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_6 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_6.add("--context=dev");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_6 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_6 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_6.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_6.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_6.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_6.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_6.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_6.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_6.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_6.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_6.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_6.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_6 = null;
		...
		analysis_twitter.s5_fr_calcul_sentiments_depuis_donnees_tweets_0_1.s5_fr_calcul_sentiments_depuis_donnees_tweets childJob_tRunJob_6 = new analysis_twitter.s5_fr_calcul_sentiments_depuis_donnees_tweets_0_1.s5_fr_calcul_sentiments_depuis_donnees_tweets();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_7 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_7.add("--context=dev");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_7 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_7 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_7.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_7.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_7.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_7.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_7.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_7.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_7.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_7.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_7.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_7 = null;
		...
		analysis_twitter.s5_in_calcul_sentiments_depuis_donnees_tweets_0_1.s5_in_calcul_sentiments_depuis_donnees_tweets childJob_tRunJob_7 = new analysis_twitter.s5_in_calcul_sentiments_depuis_donnees_tweets_0_1.s5_in_calcul_sentiments_depuis_donnees_tweets();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_8 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_8.add("--context=dev");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_8 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_8 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_8.put("connection_postgres_Server", context.connection_postgres_Server);
                    paraList_tRunJob_8.add("--context_type " + "connection_postgres_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_8.put("connection_postgres_Login", context.connection_postgres_Login);
                    paraList_tRunJob_8.add("--context_type " + "connection_postgres_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_8.put("connection_postgres_Port", context.connection_postgres_Port);
                    paraList_tRunJob_8.add("--context_type " + "connection_postgres_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_8.put("connection_postgres_Password", context.connection_postgres_Password);
                    paraList_tRunJob_8.add("--context_type " + "connection_postgres_Password" + "=" + "id_String");
                    parentContextMap_tRunJob_8.put("connection_postgres_Database", context.connection_postgres_Database);
                    paraList_tRunJob_8.add("--context_type " + "connection_postgres_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_8.put("connection_postgres_Schema", context.connection_postgres_Schema);
                    paraList_tRunJob_8.add("--context_type " + "connection_postgres_Schema" + "=" + "id_String");
                    parentContextMap_tRunJob_8.put("connection_postgres_AdditionalParams", context.connection_postgres_AdditionalParams);
                    paraList_tRunJob_8.add("--context_type " + "connection_postgres_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_8.put("path_files_global", context.path_files_global);
                    paraList_tRunJob_8.add("--context_type " + "path_files_global" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_8 = null;
		...
		analysis_twitter.s6_telechargement_mesures_dans_dw_0_1.s6_telechargement_mesures_dans_dw childJob_tRunJob_8 = new analysis_twitter.s6_telechargement_mesures_dans_dw_0_1.s6_telechargement_mesures_dans_dw();
	    // pass DataSources
 ...
 */
	...
	String messagetMsgBox_1 = "Les actions faites :\nEt 0 : Connexion api twitter\nEt 1 : Téléchargement des tweets dans de la base de données\nEt 2 : Té"
+"léchargement des dimension dans de dw\nEt 3 : Téléchargement des données de region et description de hashtag\nEt 4 : Calcu"
+"l des mesures\nEt 5 : Calcul de sentiments\nEt 6 : Téléchargement des mesures dans la table de faits\nFin de traitements et"
+" analysis de données twitter";   	
 ...
 */
    ...
    public static void main(String[] args){
        final workflow_final workflow_finalClass = new workflow_final();

        int exitCode = workflow_finalClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = workflow_final.class.getClassLoader().getResourceAsStream("analysis_twitter/workflow_final_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = workflow_final.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : workflow_final");
        }
...
/************************************************************************************************
 *     114996 characters generated by Talend Open Studio for Big Data 
 *     on the December 12, 2020 5:06:26 PM CET
 ************************************************************************************************/